...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Consolidado Reporte Diario Equipos</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
foreach ($campos as $campo){
            ...
            $unidad_reportada = $campo['unidad_trabajo'];
            ...
            $observaciones = $campo['observaciones'];
             ...
             <td><?php echo utf8_encode(fechalarga($fecha_reporte)); ?></td>
              <td class="text-center"><?php echo utf8_encode($num_trabajado); ?></td>
              <td class="text-center"><?php echo utf8_encode($dias_trabajados); ?></td>
              <td class="text-center"><?php echo utf8_encode($num_galones); ?></td>
          ...
          "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api.column( 1 ).footer() ).html(
             ...
             $( api.column( 2 ).footer() ).html(
                ''+format2(pageTotal2,'' )+' Días'
            ); 
             $( api.column( 3 ).footer() ).html(
                ''+format2(pageTotal3,'' )+' Gl'
            ); 
