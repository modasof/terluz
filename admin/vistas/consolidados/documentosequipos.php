...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Consolidado Gestión Documental Equipos</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
            <li class="breadcrumb-item active">Documentos Equipos</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <div class="content">
    ...
    <div class="card card-primary">
      <div class="card-body">
         <!--  <a href="?controller=documentos&&action=nuevo" class="btn btn-success" style="float: right;"><i class="fa fa-plus-square bigger-110 "></i> Crear Documento</a>
          <br><br> -->
    ...
    <!--  <div class="card-header">
      ...
      <div class="clearfix">
       ...
       <tbody>
            ...
            $nombrecuenta=Consolidados::obtenerNombreEquipo($cuenta_id_cuenta);
            $alerta = $campo['alerta'];
            ...
            ?>
             <tr class='success text-success'>
              <td class="text-center"><?php echo utf8_encode($nombrecuenta); ?> </td>
              <td><a target="_blank" href="<?php echo($imagen); ?>"  class="tooltip-primary text-primary" title="Ver Soporte"><?php echo utf8_encode($nombredocumento); ?></a></td>
              <?php 
              if ($alerta=="Si") {
               ?>
            ...
            <button type="button" class="btn btn-default btn-flat"><a href="?controller=gestiondocumentaleq&&action=editar&&idreg=<?php echo $idregistro;?>&&id_modulo=<?php echo($modulo_gestion); ?>&&id=<?php echo($cuenta_id_cuenta); ?>" class="tooltip-primary text-success" title="Actualizar Documento">
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=documentos&&action=eliminar&&id="+id;
else
