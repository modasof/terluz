					...
					<div class="row">
						...
						<div class="col-md-12">
						  ...
						  <div class="card card-primary">
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="?controller=egresoscuenta&&action=actualizarot&&id=<?php echo($id_egreso_cuenta); ?>&&id_cuenta=<?php echo($CuentaSel); ?>" method="POST" enctype="multipart/form-data">
								<?php  
											 ...
											 <div class="col-12">
												<div class="form-group">
												  <label for="nombres">Descripción del Egreso (Máx 500 Carácteres)</label>
													  ...
													  <textarea class="form-control" rows="3" name="observaciones" id="descripcion" placeholder="Ingrese la descripción del gasto" maxlength="500" required>
										...
										<div  class="col-md-12">
											...
											<div  id="divbeneficiario" class="col-md-12">
												<div class="form-group">
													...
													<input type="text" name="beneficiario" placeholder="Nombre del beneficiario" class="form-control  id="beneficiario" value="<?php echo($beneficiario) ?>">
												</div>
											</div>
