...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Informe Novedades</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
      <div class="row">
		...
		<div class="card card-primary">
			<div class="card-body">
				  <form action="?controller=novedades&&action=novedadesporfecha" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
       ...
       <div class="col-sm-12">
        ...
        if ($fechaform!="") {
          ?>
           <h3 class="m-0 text-dark">Informe Novedades del <?php echo(fechalarga($datofechain)) ?> al <?php echo (fechalarga($datofechafinal)) ?></h3>
          <?php
        }
        else
        {
          ?>
           <h3 class="m-0 text-dark">Informe Total novedades </h3>
          <?php
        }
         ...
         ?>
          ...
          <tbody>
            <?php
             if ($fechaform!="") {
              $res=Novedades::ReporteNovedadesporfecha($FechaStart,$FechaEnd);
            ...
            <tr>
              ...
              <td class="text-center"><?php echo $id; ?> </td>
               <td><?php echo utf8_encode($nombrefuncionario); ?></td>
               <td><?php echo utf8_encode($tipo_novedad); ?></td>
              <td><?php echo utf8_encode(fechalarga($fecha_novedad)); ?></td>
              <td><?php echo utf8_encode($observaciones); ?></td>
               <td><?php echo utf8_encode($reportado_por); ?></td>
              <td>

              <a href="?controller=novedades&&action=editar&&id=<?php echo $id; ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Novedad">
                <i class="fa fa-edit bigger-110 "></i>
              </a>
               <?php 
                        if ($imagen!="") {
                          ?>
                          <a target="_blank" href="<?php echo($imagen) ?>" class="btn btn-primary btn-xs"><i class="fa fa-paperclip"> </i> Soporte</a>
                          <?php
                        }
                         ?>
