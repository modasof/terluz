								  ...
								  <div class="card card-primary">
									<div class="card-header">
									  <h4 class="card-title">Configuración General</h4>
				                    	...
				                    	<form role="form" action="?controller=vehiculos&&action=guardar" method="POST" enctype="multipart/form-data" autocomplete="off">
										<fieldset>
										...
										<div class="row">
											...
											<div style="display: none;" class="col-md-4">
												...
												<div class="form-group">
													...
													<input type="text" name="ubicacion" placeholder="Ubicación ejm: Bogota D.C" class="form-control required" required value="Bogota D.C">
												</div>
											</div>
											<div style="display: none;" class="col-md-4">
												<div class="form-group">
											...
											<div style="display: none;" class="col-md-4">
												<div class="form-group">
													...
													<input type="text" name="pico_placa" placeholder="Pico y Placa" class="form-control required" required value="N/A">
												</div>
											</div>
										</div>
										<div class="row">
