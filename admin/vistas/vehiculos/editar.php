              ...
              <div class="card-body">
					<section class="content">
						<div class="container-fluid">
				           ...
				           <form role="form" action="?controller=vehiculos&&action=actualizar&&id=<?php echo $id; ?>&&tipoedicion=<?php echo('Nuevo') ?>" method="POST" enctype="multipart/form-data">
										<fieldset>
										...
										<div class="row">
											...
											<div class="col-md-4">
												...
												<div class="form-group">
													...
													<input type="text" name="ubicacion" placeholder="Ubicación ejm: Bogota D.C" class="form-control "  value="<?php echo $ubicacion; ?>">
												</div>
											</div>
											<div style="display: none;" class="col-md-4">
												<div class="form-group">
													<label>Kilometraje:  <span>*</span></label>
													<input type="number" name="kilometros" placeholder="Kilometraje ejm: 0" class="form-control "  value="<?php echo $kilometros; ?>">
												</div>
											</div>
											<div style="display: none;" class="col-md-4">
												<div class="form-group">
													<label>Terminación Pico y Placa:  <span>*</span></label>
													<input type="text" name="pico_placa" placeholder="Pico y Placa" class="form-control "  value="N/A">
												</div>
											</div>
										</div>
										<div class="row">
												...
												<div style="display: none;" class="col-6">
													<div class="form-group">
														<label>Precio Oferta<span>*</span></label>
														  <input type="number" name="precio_oferta" placeholder="Precio en Oferta" class="form-control required" value="0" required value="<?php echo $precio_oferta; ?>">
													</div>
												</div>
											</div>
										</div>
