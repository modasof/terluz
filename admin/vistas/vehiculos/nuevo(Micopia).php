									...
									<div class="card-header">
									  <h4 class="card-title">Configuración General</h4>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>Tipo de Versión: <span>*</span></label>
										...
										<div class="form-group">
											...
											<div class="form-group">
												<div class="col-md-12">
													...
													<div class="custom-file">
														<input name="img_ofertas" type="file" id="input-file-now" class="dropify" data-default-file="vistas/vehiculos/imagenes/principal.jpg" data-allowed-file-extensions="png jpg jpeg mp4 webm" data-show-errors="true" data-max-file-size="2M" data-errors-position="outside" accept="image/png, .jpeg, .jpg, image/gif, .mp4, .webm, .pdf"/>
													</div>
												 </div>
											</div>
										</div>
