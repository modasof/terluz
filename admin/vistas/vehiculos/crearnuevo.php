								  ...
								  <div class="card card-primary">
									<div class="card-header">
									  <h4 class="card-title">Configuración General</h4>
				                    	...
				                    	<form role="form" action="?controller=vehiculos&&action=guardar&&tipoguardar=Nuevo" method="POST" enctype="multipart/form-data" autocomplete="off">
										<fieldset>
										...
										<div class="row">
											...
											<div style="display: none;" class="col-md-4">
												...
												<div class="form-group">
													...
													<input type="text" name="ubicacion" placeholder="Ubicación ejm: Bogota D.C" class="form-control"  value="Bogota D.C">
												</div>
											</div>
											<div style="display: none;" class="col-md-4">
												<div class="form-group">
													<label>Kilometraje:  <span>*</span></label>
													<input type="number" name="kilometros" placeholder="Kilometraje ejm: 0" class="form-control " >
												</div>
											</div>
											<div style="display: none;" class="col-md-4">
												<div class="form-group">
												...
												<div style="display: none;" class="col-6">
													<div class="form-group">
														<label>Precio Oferta<span>*</span></label>
														  <input type="number" name="precio_oferta" placeholder="Precio en Oferta" class="form-control required" value="0" required>
													</div>
												</div>
											</div>
										</div>
