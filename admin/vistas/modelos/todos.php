...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Modelos de Vehiculos</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <div class="content">
    ...
    <div class="card card-primary">
      <div class="card-body">
          <a href="?controller=modelos&&action=nuevo" class="btn btn-success" style="float: right;"><i class="fa fa-plus-square bigger-110 "></i> Crear Referencia</a>
          <br><br>
      ...
      <div class="clearfix">
       ...
       <tbody>
            ...
            <tr>
              ...
              <td>
              <a href="?controller=modelos&&action=editar&&id=<?php echo $id; ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Modelo">
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=modelos&&action=eliminar&&id="+id;
else
