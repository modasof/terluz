...
include_once 'controladores/cajasController.php';
  ...
  $cajas = Ingresos::obtenerCajapor($CajaSel);
      foreach($cajas as $caja){
      $id_caja = $caja['id_caja'];
      $nombre_caja = $caja['nombre_caja'];
      }
  $ingresoInicial=Ingresos::ingresoInicial($CajaSel);
  $ingresosporcaja=Ingresos::IngresosPorcaja($CajaSel);
  $ingresosporcuenta=Ingresos::IngresosPorcuenta($CajaSel);
  $totalingresos=$ingresoInicial+$ingresosporcaja+$ingresosporcuenta;
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Ingresos <?php echo utf8_encode($nombre_caja) ?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=cajas&&action=todos">Cajas</a></li>
            <li class="breadcrumb-item active">Ingresos Caja </li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Valor Inicial</span>
              <span class="info-box-number"><?php Echo utf8_encode("$ ".number_format($ingresoInicial));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Ingreso por Cajas</span>
              <span class="info-box-number"><?php Echo utf8_encode("$ ".number_format($ingresosporcaja));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Ingreso por Cuentas</span>
              <span class="info-box-number"><?php Echo utf8_encode("$ ".number_format($ingresosporcuenta));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
    ...
    <div class="card card-default">
      ...
      <div class="clearfix">
          ...
          $campos = $campos->getCampos();
            ...
            {
              $soporte=Ingresos::obtenerSoporteCuenta($caja_ppal,$marca_temporal);
            }
...
function eliminar(id,cajasel){
   ...
   if (eliminar)
     window.location.href="?controller=ingresos&&action=eliminar&&id="+id+"&&id_caja=+"+cajasel;
else
