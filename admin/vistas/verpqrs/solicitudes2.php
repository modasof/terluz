...
?>
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4 class="m-0 text-dark">PQRS <?php echo $servicio;?></h4>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-md-3">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Areas Involucradas</h3>
					...
					<?php 
						...
						foreach($valor as $campo){ 
						  ...
						  <tr>
							...
							<td class="mailbox-name"><a href="?controller=pqrs&&action=versolicitud&&id=<?php echo $campo['id'];?>"><?php echo utf8_encode($campo['persona']); ?></a></td>
							<td class="mailbox-subject"><b><?php echo utf8_encode($campo['motivo']); ?>:</b> <?php echo substr(utf8_encode($campo['comentario']),0,60)."....<b>".$fecha."</b>"; ?></td>
