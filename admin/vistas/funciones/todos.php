...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Funciones del Vehiculos</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
      <div class="row">
		...
		<div class="card card-primary">
			<div class="card-body">
				  <a href="?controller=funciones&&action=nuevo" class="btn btn-success" style="float: right;"><i class="fa fa-file-text-o bigger-110 "></i>Nueva Función</a>
				  <br><br>
				  ...
				  <tbody>
					  ...
					  foreach ($campos as $campo){
						...
						<tr>
							...
							<td><?php echo $tipo; ?></td>
							<td>
							<a href="?controller=funciones&&action=editar&&id=<?php echo $id; ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Funcion">
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=funciones&&action=eliminar&&id="+id;
else
