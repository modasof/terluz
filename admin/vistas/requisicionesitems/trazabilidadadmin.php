        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
             <li class="breadcrumb-item active"><a href="?controller=requisiciones&&action=todosporusuarioadmin">Ver Requisiciones</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
		...
		<div class="container-fluid">
          ...
          <div class="box box-primary direct-chat direct-chat-primary">
            ...
            <div class="box-footer">
              <form action="?controller=requisicionesitems&action=actualizarestado&&id=<?php echo($idreq); ?>" method="post">
