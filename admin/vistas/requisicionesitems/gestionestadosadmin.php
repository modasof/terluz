					...
					<div class="row">
						...
						<div class="col-md-12">
						  ...
						  <div class="card card-primary">
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="?controller=requisicionesitems&action=actualizarestadoadmin&&id=<?php echo($idreq); ?>" method="POST" enctype="multipart/form-data">
							  ...
							  <div class="card-body">
								...
								<div class="row">
									<div class="col-md-4">
										...
										<?php
										$rubros = Estadosreq::ObtenerListaEstadosaprobaciones();
