...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Reporte Requisiciones</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
		...
		<div class="container-fluid">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Reportes Requisiciones </h3>
            ...
            <div class="box-body">
            	            <div class="row">
        <form action="?controller=requisiciones&&action=porfecha" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
       ...
       <div class="col-sm-12">
        ...
        if ($fechaform!="") {
          ?>
           <h3 class="m-0 text-dark">Reporte Requisiciones <?php echo(fechalarga($datofechain)) ?> al <?php echo (fechalarga($datofechafinal)) ?></h3>
          <?php
        }
        else
        {
          ?>
           <h3 class="m-0 text-dark">Reporte Requisiciones</h3>
          <?php
        }
       ...
       <tbody>
            ...
            $estado_requisicion = $campo['estado_requisicion'];
            ...
            <tr>
              ...
              <li>
               <a href="?controller=requisiciones&&action=itemsolicitados" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Agregar Insumos">
                <i class="fa fa-plus-square bigger-110 "> Agregar Insumos</i>
              </a>
                </li> 
                          <li>
              ...
              <a download="Soporte" href="<?php echo($imagen); ?>"  class="tooltip-primary text-dark" title="Descargar Soporte">
                <i class="fa fa-cloud-download bigger-110 "> Descargar</i>
                          ...
                          <li>
              <a href="?controller=requisiciones&&action=editar&&id=<?php echo $id; ?>&&vereditar=1" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Horas">
                <i class="fa fa-edit bigger-110 "> Editar</i>
              </a>
                          </li>
                          <li>
              <a href="#" onclick="eliminar(<?php echo $id; ?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar Requisición">
