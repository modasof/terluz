...
<div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true">Total Compras</a></li>
              <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false">De contado</a></li>
              <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="false">A crédito</a></li>
            </ul>
...
======================================-->
            ...
            <div class="clearfix">
                 <a id="btnrelacionar" href="" class="btn btn-success" style="float: right; display: none; cursor: pointer;"><i class="fa fa-exchange bigger-110 "></i> Gestionar Compra</a>
                  <br><br>
...
echo ("OC00" . $id);
    ...
    ?>
                ...
                <td><?php echo ($vencimiento); ?> Días</td>
...
foreach ($camposb as $campo2) {
    ...
    ?>
            <tr>
                <td>
                    <?php if ($medio_pago == "Contado") {
        ?>
                        <a href="?controller=compras&action=cambiarestado&id=<?php echo ($id); ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Detalle">
