...
for($i=0; $i<$min; $i++)
	...
	echo("<td><input disabled class='input-sm' type='text' name='valor_iva' value='".number_format($sumasubtotalajax,0)."'><td>");

	echo("<td><input id='campoiva' type='hidden' name='valor_iva_txt' value='".$sumasubtotalajax."'><td>");
