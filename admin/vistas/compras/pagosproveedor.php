...
$proveedorsel=$_GET['idproveedor'];
$relacionid=$_GET['id'];
$relacionvalor=$_GET['valor'];
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Autorización por <?php echo("$".number_format($relacionvalor,0)) ?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
            <li class="breadcrumb-item active"><a href="?controller=proveedores&&action=showrelacionpagos">Relación de Pagos</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <a id="btnrelacionar" href="" class="btn btn-success" style="float: right; display: none; cursor: pointer;"><i class="fa fa-exchange bigger-110 "></i> Cargar Abonos</a>
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true">OC Pendientes x Pago</a></li>
...
foreach ($campos as $campo) {
    ...
    ?>
            ...
            <a style="display:none;" href="?controller=compras&action=cambiarestado&id=<?php echo ($relacionid); ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Detalle">
                <i class="fa fa-dollar bigger-110 "> </i></a>

                  <input type="checkbox" id="<?php echo $id; ?>" name="inputdespachos" onclick="marcardespacho(<?php echo $id; ?>,<?php echo $relacionid; ?>)" style="cursor: pointer;">
...
<script>
  ...
  function marcardespacho(id,relacion){
    ...
    if (valoresconcant==""){
      ...
      btn.style.display = "";
      btn.href = "?controller=compras&action=cambiarestadocreditos&des="+valoresconcant+"&id="+id+"&relacionid="+relacion;
    }
