...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Insumos por Campamento</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
            <li class="breadcrumb-item active">Insumos por Campamento</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <div class="content">
    ...
    <div class="card card-primary">
      <div class="card-body">
          <a href="?controller=insumoscampamento&&action=nuevo" class="btn btn-success" style="float: right;"><i class="fa fa-plus-square bigger-110 "></i> Agregar / Disminuir Insumo</a>
          <br><br>
      ...
      <div class="clearfix">
       ...
       <tbody>        
            ...
            <tr>
              ...
              <td><?php echo utf8_encode($nombre_campamento); ?></td>
