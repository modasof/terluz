...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Total Salidas Caja</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <div class="content">
    ...
    <div class="card card-default">
      <div class="card-body">
            <div class="row">
        <form action="?controller=gastos&&action=porfecha" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
      ...
      <div class="clearfix">
         ...
         <table id="cotizaciones" class="table  table-responsive table-striped table-bordered table-hover" style="width: 100%; font-size: 13px;">
          ...
          <tbody>
            <?php
 if ($fechaform!="") {
              $res=Gastos::Totalporfecha($FechaStart,$FechaEnd);
