...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Versiones del Vehiculo</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
 ...
 <div class="content">
    ...
    <div class="card card-primary">
      <div class="card-body">
          <a href="?controller=versiones&&action=nuevo" class="btn btn-success" style="float: right;"><i class="fa fa-plus-square bigger-110 "></i> Crear Versión</a>
          <br><br>
    ...
    <!--  <div class="card-header">
      ...
      <tbody>
            ...
            <tr>
              ...
              <td>
              <a href="?controller=versiones&&action=editar&&id=<?php echo $id; ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Version">
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=versiones&&action=eliminar&&id="+id;
else
