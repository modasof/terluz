    ...
    <!--  <div class="card-header">
      ...
      <div class="clearfix">
       ...
       <tbody>
            ...
            $modulo = Documentos::obtenerRubro($modulo_id_modulo);
            ...
            <tr>
              ...
              <td>
              <a href="?controller=documentos&&action=editar&&id=<?php echo $id; ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Documento">
                <i class="fa fa-edit bigger-110 "></i>
              </a>
              <a href="#" onclick="eliminar(<?php echo $id; ?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar Documento">
