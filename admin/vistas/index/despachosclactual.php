<?php 
            ...
            <div class="box-header">
              <h3 class="box-title">Total M3 Mes <?php echo(round($Acpmmesactual,1)); ?></h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <?php
                    $rubros = Clientes::obtenerListaClientesDespachos($FechaInicioDia,$FechaFinalDia);
                    foreach ($rubros as $campo){
                      ...
                      $ViajesCliente=ViajesCliente($cliente_id_cliente,$FechaInicioDia,$FechaFinalDia);
