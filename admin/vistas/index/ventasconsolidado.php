<?php 
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <?php
                  ...
                  <td><?php echo utf8_encode("$".number_format($AbonosCliente,0)); ?></td>
                  <td><span class="badge bg-aqua">
                    <?php echo utf8_encode("$".number_format($saldo,0)); ?>
                  </span>
             ...
             <tr>
               <th></th>
               <th> <?php echo utf8_encode("$".number_format($Acpmmesconsolidado,0)); ?></th>
               <th> <?php echo utf8_encode("$".number_format($Abonosmes,0)); ?></th>
              <th> <?php echo utf8_encode("$".number_format($saldototal,0)); ?></th>
               <th></th>
             </tr>
              </table>
          </div>
