...
?>
        ...
        <!-- /.col -->
           ...
           <div class="col-md-4 col-xs-12">
            <div class="chart">
                    <!-- Sales Chart Canvas -->
                   <div id="grafica_2" style="height: 300px; width: 100%;"></div>
        </div>
          <!--<div class="box box-primary collapsed-box">-->
         <div class="box box-primary">
            <div class="box-header with-border">
...
?>
        ...
        <div class="chart">
         ...
         <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Compras <small> Actualizado al <?php
date_default_timezone_set("America/Bogota");
$TiempoActual = date('Y-m-d');
echo (fechalarga($TiempoActual));
?></small></h3>
...
$ventames1 = Comprasmesgeneral($i, $anoactual);
    ...
    $maxviajes  = max($CadenaAt);
    $promedio33 = $sumaAt / $longitudAt;
    echo ("<a style='color:black;' href='?controller=reportes&&action=despachosclientes&daterange=" . $fechaconsulta . "'><small style='color:#128a2e;'></small> $" . number_format($arreglof, 0) . "</a>");
    ?>
                  </td>
                  <td>
                    <?php
$ventames17 = Comprasmesgeneral($i, $anoactual);
    ...
    echo ("<a style='color:black;' href='?controller=reportes&&action=despachosclientes&daterange=" . $fechaconsulta . "'><small style='color:#128a2e;'></small>$ " . number_format($saldocxp, 0) . "</a>");
