<?php 
            ...
            <div class="box-header">
              <h3 class="box-title">Informe x Material <?php echo(round($sumadeldia,1)); ?> M3</h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <?php
                    $rubros = Clientes::obtenerListaMaterialDespachos($elcliente,$FechaInicioDiaActual,$FechaFinalDiaActual);
                    foreach ($rubros as $campo){
                      ...
                      $ViajesMaterial=ViajesMaterial($elcliente,$producto_id_producto,$FechaInicioDiaActual,$FechaFinalDiaActual);
...
<hr>
 <div class="box-header">
              <h3 class="box-title">Informe x Volqueta <?php echo(round($sumadeldia,1)); ?> M3</h3>
            </div>
               <table class="table table-hover" style="font-size: 13px;">
                <tr class="danger">
                  <th>Volqueta</th>
              ...
              <?php
                    $rubros = Clientes::obtenerListaPlacasDespachos($elcliente,$FechaInicioDiaActual,$FechaFinalDiaActual);
                    foreach ($rubros as $campo){
                      $equipo_id_equipo = $campo['equipo_id_equipo'];
                      $Totales = $campo['Totales'];
                      $nomlista=Equipos::obtenerPlacaEquipo($equipo_id_equipo);
                      $Propietario=Equipos::obtenerPropietarioEquipo($equipo_id_equipo);
                  $ViajesMaterialPlaca=ViajesMaterialPlaca($elcliente,$equipo_id_equipo,$FechaInicioDiaActual,$FechaFinalDiaActual);
