            ...
            <div class="box-body">
              <div class="box-group" id="accordion">
                ...
                if ($calculo>0) {
                 ...
                 ?>
                           <strong> <?php echo utf8_encode("$".number_format($Acpmmesactual,0)); ?></strong>
                      </a>
                    </h4>
                  </div>
                  ...
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                        ...
                        <strong> <?php echo utf8_encode("$".number_format($Acpmmesanterior,0)); ?></strong>
                      </a>
                    </h4>
                  </div>
                  ...
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">
                        ...
                        <strong> <?php echo utf8_encode("$".number_format($Acpmmesconsolidado,0)); ?></strong>
                      </a>
                    </h4>
                  </div>
