  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">Cajas</span><br>
      ...
      <a href="?controller=reportes&&action=insumosxpagar">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Registro </span>
              <span class="info-box-number">Insumos</span><br>
              <span class="info-box-number">Obinco</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
       ...
       <a href="?controller=reportes&&action=despachosclientes">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Registro </span>
              <span class="info-box-number">Despacho Cliente</span><br>
      ...
      <a href="?controller=reportes&&action=horas">
       ...
       <a href="?controller=equipos&&action=volquetas">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-red"><i class="fa fa-truck"></i></span>
            <div class="info-box-content">
       ...
       <a href="?controller=index&&action=informegerencia">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
