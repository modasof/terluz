 <?php 
            ...
            <div class="box-header">
              <h3 class="box-title">Total Combustible Mes <?php echo($Acpmmes); ?></h3>
              <h1><?php echo("FECHA QUE LLEGA:".$InicioMesanterior."<br>");?></h1>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <?php
                    $rubros = Equipos::obtenerListaEquiposCombustible($InicioMesanterior,$FinalMesanterior);
                    foreach ($rubros as $campo){
                      $equipo_id_equipo = $campo['equipo_id_equipo'];
                      $Galones = $campo['Galones'];
                      $nomequipo=Equipos::obtenerNombreEquipo($equipo_id_equipo);
                      $horasequipo=HorasEquipo($equipo_id_equipo,$InicioMesanterior,$FinalMesanterior);
                    ?>
                    <tr>
                 ...
                 <td>
                  <?php 
                    $porcentaje=$Galones/$Acpmmesanterior*100;
