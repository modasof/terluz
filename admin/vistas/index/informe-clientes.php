...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
   ...
   <h1 class="text-center">Informe Despacho clientes <br> <small> <?php 
              date_default_timezone_set("America/Bogota");
              ...
              <div class="box-group" id="accordion">
                ...
                <div class="panel box box-primary">
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                        Hoy
                        <?php  $sumadeldia=Despachosclmes($FechaInicioDiaActual,$FechaFinalDiaActual); ?>
                  ...
                  <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="box-body">
                     <?php require 'despachosclhoy.php'; ?>
                    </div>
                  </div>
                </div>
                <div class="panel box box-danger">
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                        Mes Actual 
                        <?php $Acpmmesactual=Despachosclmes($FechaInicioDia,$FechaFinalDia); ?>
                  ...
                  <div id="collapseTwo" class="panel-collapse collapse">
                    <div class="box-body">
                      <?php require 'despachosclactual.php'; ?>
                    </div>
                  </div>
                </div>
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                        Mes Anterior
                         <?php  $Acpmmesanterior=Despachosclmes($InicioMesanterior,$FinalMesanterior); ?>
                  ...
                  <div id="collapseThree" class="panel-collapse collapse">
                    <div class="box-body">
                     <?php require 'despachosclanterior.php'; ?>
                    </div>
                  </div>
                </div>
              </div>
...
$res=Reportes::GraficaReporteDiarioDespachoscl($mesactual);
