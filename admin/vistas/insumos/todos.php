...
<div class="content-wrapper">
  ...
  <div class="content">
    ...
    <div class="card card-primary">
      <div class="card-body">
          <a href="?controller=insumos&&action=nuevo" class="btn btn-success" style="float: right;"><i class="fa fa-plus-square bigger-110 "></i> Crear Insumo</a>
          <br><br>
...
foreach ($campos as $campo) {
    ...
    ?>
            <tr>
              <td><?php echo utf8_encode($nombre_insumo); ?></td>
              <td><?php echo utf8_encode($nombrecategoria); ?></td>
               <td><?php echo utf8_encode("$ " . number_format($valorpromedio, 0)); ?>
                 <br>
                 <a href="?controller=cotizaciones&&action=todosporinsumo&&id=<?php echo($id) ?>">Ver Histórico</a>
               </td>
              <td><?php echo utf8_encode($EntradasIns); ?></td>
              <td><?php echo utf8_encode($SalidasIns); ?></td>
               <td><?php echo utf8_encode($SaldoInsumo); ?></td>
              <td><?php echo utf8_encode($Unidad); ?></td>
               <td><?php echo utf8_encode($parametrizado); ?></td>
                <td><?php echo utf8_encode($cantidadminima); ?></td>
              <td>
              <a href="?controller=insumos&&action=editar&&id=<?php echo $id; ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Insumo">
                <i class="fa fa-edit bigger-110 "></i>
              </a>
              <a href="#" onclick="eliminar(<?php echo $id; ?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar Insumo">
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=insumos&&action=eliminar&&id="+id;
else
