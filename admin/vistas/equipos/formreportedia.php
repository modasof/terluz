...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Reporte Diario</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
					...
					<div class="row">
						...
						<div class="col-md-12">
						  ...
						  <div class="card card-primary">
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="?controller=equipos&&action=guardareporte&&id_equipo=0" method="POST" enctype="multipart/form-data" autocomplete="off">
							<?php  
							...
							<div class="row">
								...
								<div class="col-sm-6 col-xs-12">
									<div class="form-group">
									  <label for="sel1">Selecione el Equipo:</label>
						<select class="form-control" id="equipo_id_equipo" name="equipo_id_equipo" required>
										<option value="" selected>Seleccione el equipo</option>
										<?php
										...
										<?php } ?>
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="number" step="any" name="num_trabajado" placeholder="Indique el número de Hr/Km trabajadas" class="form-control" required value="">
