...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Informe de estado de Equipos</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
          <div class="row">
        <form action="?controller=equipos&&action=estadosporfecha" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
       ...
       <div class="col-sm-12">
        ...
        if ($fechaform!="") {
          ?>
           <h3 class="m-0 text-dark">Reporte Estados del <?php echo(fechalarga($datofechain)) ?> al <?php echo (fechalarga($datofechafinal)) ?></h3>
          <?php
        }
        else
        {
          ?>
           <h3 class="m-0 text-dark">Reporte Total Estados </h3>
          <?php
        }
      ...
      <div class="clearfix">
          ...
          <thead>
            ...
            //$unidad_reportada=Equipos::obtenerNombreTipoUnidad($id_equipo);
              ...
              <td><?php echo utf8_encode($nombreequipo); ?></td>
        
              <td><?php echo utf8_encode($fecha_reporte); ?></td>
               <td><?php echo utf8_encode($nombreusuario); ?></td> 
                <td><?php echo utf8_encode($estado_sel); ?></td>
                <td><?php echo utf8_encode($tiempo); ?></td> 
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=equipos&&action=eliminarestado&&id="+id;
else
