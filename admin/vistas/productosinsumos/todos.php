...
$camposProducto = $camposProducto->getCampos();
foreach ($camposProducto as $camposProductoUnico){
  $id_productoUnico = $camposProductoUnico['id_producto'];
  $nombre_productoUnico = $camposProductoUnico['nombre_producto'];
}
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="m-0 text-dark">Insumos del Producto: <?php echo $nombre_productoUnico;?></h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
            <li class="breadcrumb-item active">Insumos del Producto</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <div class="content">
    ...
    <div class="card card-primary">
      <div class="card-body">
          <a href="?controller=productosinsumos&&action=nuevo&id=<?php echo $id_productoUnico;?>" class="btn btn-success" style="float: right;"><i class="fa fa-plus-square bigger-110 "></i> Relacionar Insumo al Producto</a>
          <br><br>
      ...
      <div class="clearfix">
       ...
       <tbody>        
            ...
            foreach ($campos as $campo){
              ...
              $fecha_modificado = $campo['fecha_modificado'];              
            ...
            <tr>
              ...
              <td><?php echo utf8_encode($fecha_modificado); ?></td> 
              <td>
                <a href="#" onclick="eliminar(<?php echo $id; ?>,<?php echo $producto_id_producto;?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar Insumo del Producto">
...
<script>
function eliminar(id, prod_id){
   eliminar=confirm("¿Deseas eliminar este registro?");
   if (eliminar){   
     window.location.href="?controller=productosinsumos&&action=eliminar&id="+prod_id+"&&eid="+id;
   }    
}
</script>
