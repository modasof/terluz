...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Relacionar Insumo al Producto</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
            <li class="breadcrumb-item active"><a href="?controller=insumos&&action=todos">Insumo al Producto</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
					...
					<div class="row">
						...
						<div class="col-md-12">
						  ...
						  <div class="card card-primary">
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="?controller=productosinsumos&&action=guardar" method="POST" enctype="multipart/form-data">
								<input type="hidden" name="estado_insumo" value="1">
							  <div class="card-body">
								<div class="card-header">
								  <h3 class="card-title">Relacionar Insumo al Producto</h3>
								</div>
										...
										<div class="form-group">
										  ...
										  <select class="form-control" id="producto_id_producto" name="producto_id_producto" required>
											...
											foreach ($productos as $producto){
												...
												if ($idproducto==$get_id){
													$prodselected = " selected = 'selected'";	
												}
												
											?>
											<option value="<?php echo $idproducto; ?>" <?php echo $prodselected;?>><?php echo $nombre_producto; ?></option>
											<?php } ?>
										  </select>
										</div>
									</div>
