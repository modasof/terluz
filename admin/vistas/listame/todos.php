...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Lista de Maquinaría y Equipos (L-ME)</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
?>
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Listado de Maquinaría y Equipos </h3>
...
foreach ($campos as $campo) {
    ...
    ?>
            <tr>
              ...
              <a href="?controller=listame&&action=editar&&id=<?php echo $id_lme; ?>&&vereditar=1" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar">
                <i class="fa fa-edit bigger-110 "></i>
              </a>
              <a href="#" onclick="eliminar(<?php echo $id_lme; ?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar">
                <i class="fa fa-trash bigger-110 "></i>
              </a>
              </td>
              <td><?php echo ("LME-" . $id_lme); ?></td>
              <td><?php echo utf8_decode($nombre_lme); ?></td>
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=listame&&action=eliminar&&id="+id;
else
