...
$rangos       = Obras::unicorangoporobra($getobra,$getrango);
 ...
 <td>
     <?php 
     echo (round($sqlcantidades,2)."-".$nomunidad);
      ?>
 </td>
...
<?php
    ...
    ?>
    <td>
        <a target="_blank" href="?controller=horasmq&&action=horas&&id_obra=<?php echo($getobra); ?>">
        <?php 
            $totalhorasreportadas = Proyeccioneslme::sqlcantidadesreportadas($getobra,$fecha_inicio_act,$fecha_fin_act,$lme_id_lme);
            echo round($totalhorasreportadas,2);
         ?>
         </a>
    </td>
