...
<h3 class="box-title">Proyecto : <strong><?php echo utf8_decode($nombre_obra); ?></strong> Duración :<strong><?php $totaldias = tiempoTranscurridoFechas($inicioobra,$finalobra); echo($totaldias)?> </strong></h3>

</div>

<div class="box-body">
   <form role="form" action="?controller=proyeccioneslme&&action=guardar&&id=<?php echo ($getobra); ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
<?php  
...
<dd>
  <div class="col-md-12">
    ...
    <div class="col-md-12">
      ...
      <select name="lme_id_lme" class="form-control mi-selector" >
        <option value="">Seleccionar... </option>
        <?php
$cajas = Listame::obtenerLista();
foreach ($cajas as $caja) {
    $id_lme           = $caja['id_lme'];
    $nombre_lme       = $caja['nombre_lme'];
    ...
    <input type="number" step="any" name="cantidad_lme" placeholder="Cantidades Proyectadas" class="form-control" required value="">
    ...
    <div class="col-md-12">
            <div class="form-group">
                <label>Valor Unitario: <span>*</span></label>
                    <input type="text" name="valor_unitario_lme" placeholder="Valor del gasto" class="form-control" id="demo1">
            </div>
    </div>
...
<div style="background-color: white;" class="col-md-12">
  ...
  <div class="box-header with-border">
    <h1>PROYECCIÓN DE EQUIPOS </h1>
<i class="fa fa-info-circle"> </i>
<h3 class="box-title"><?php echo utf8_decode($nombre_obra); ?> <strong>Fecha Inicio : <?php echo ($inicioobra); ?> Fecha Final : <?php echo($finalobra); ?> </strong></h3>
</div>
...
?>
 ...
 <tr>
          <td>
            ...
            <br>
    <a href="#" onclick="eliminarequipo(<?php echo $getobra; ?>,<?php echo $lme_id_lme; ?>);" class="pull-right tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar">
                <i class="fa fa-trash bigger-110 "> Eliminar Equipo</i>
    </a>
        </td>
        <td>
...
$rangos       = Obras::rangosporobra($getobra);
 ...
 <td>
     <?php
        ...
        if ($sqlcantidades!=0) {
            ?>
       <a href="#" onclick="eliminar(<?php echo $id_rango_act; ?>,<?php echo $getobra; ?>,<?php echo $lme_id_lme; ?>);" class="pull-right tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar">
