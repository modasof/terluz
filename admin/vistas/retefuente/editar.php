	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
              ...
              <input type="text" name="alias_retefuente" value="<?php echo utf8_encode($alias_retefuente);?>" class="form-control" id="alias_retefuente" placeholder="Ingrese el concepto" maxlength="150" required>
              </div>
