...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Tabla de Retenciones en la Fuente</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <!--  <div class="card-header">
      ...
      <div class="clearfix">
          ...
          <thead>
              ...
              <th>Conceptos de retención</th>
              <th>Porcentajes de retención</th>
              <th>Acción</th>
            </tr>
            <tr>
       ...
       <tbody>
            ...
            <tr>
              ...
              <td><?php echo $alias_retefuente; ?></td>
              <td><?php echo utf8_encode($valor_retefuente*100); ?>%</td>
              <td>
              <a href="?controller=retefuente&&action=editar&&id=<?php echo $id; ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar">
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=retefuente&&action=eliminar&&id="+id;
else
