...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Reporte Cuentas x Cobrar consolidado</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
	...
	<div class="content">
		<div class="container-fluid">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Cuentas x Cobrar </h3>
       ...
       <div class="col-sm-12">
        ...
        if ($fechaform!="") {
          ?>
           <h3 class="m-0 text-dark">Reporte Cuentas x Cobrar del <?php echo(fechalarga($datofechain)) ?> al <?php echo (fechalarga($datofechafinal)) ?></h3>
          <?php
        }
        else
        {
          ?>
           <h3 class="m-0 text-dark">Reporte Total Cuentas por Cobrar </h3>
          <?php
        }
       ...
       <tbody>
            ...
            if ($fechaform!="") {
              $res= informecuentasporcobrar::ReporteCuentasxcobrarporfechaconsolidado($FechaStart,$FechaEnd);
            ...
            $nombrecliente = $campo['nombre_cliente'];
            
            // 1. Consulta total de ventas Material por cliente: 
            $totalventasmaterial=TotalVentasCliente($id_cliente);
            // 2. Consulta total de ventas por Alquiler cliente: 
            $totalventasalquiler=TotalPrestamosCliente($id_cliente);
            // 3. Consulta total Abonos Material por cliente: 
            $totalabonosporcliente=TotalAbonosCliente($id_cliente);
            // 4. Cruce de cuentas: 
            $sumatotalventas=$totalventasmaterial+$totalventasalquiler;
            $saldopendiente=$sumatotalventas-$totalabonosporcliente;
            ?>
            <?php 
            if ($saldopendiente!=0) {
             ?>
            <tr>
              <td>
                 <a href="?controller=reportes&&action=cuentasxpagardetalle&&idproveedor=<?php echo $proveedor_id_proveedor; ?>" class="tooltip-primary text-primary" data-rel="tooltip" data-placement="top" title="" data-original-title="Ver Detalle">
                 <?php echo utf8_encode($nombrecliente); ?> 
              </a>
               </td>
             <td><?php echo utf8_encode("$".number_format($sumatotalventas,0)); ?></td>
              <td><?php echo utf8_encode("$".number_format($totalabonosporcliente,0)); ?></td>
              <td><?php echo utf8_encode("$".number_format($saldopendiente,0)); ?></td>
