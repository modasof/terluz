...
<div class="content-wrapper">
  ...
  <div class="content">
    ...
    <div class="card card-primary">
      <div class="card-body">
          <a href="?controller=proyectos&&action=nuevo" class="btn btn-success" style="float: right;"><i class="fa fa-plus-square bigger-110 "></i> Crear Proyecto</a>
          <br><br>
    ...
    <!--  <div class="card-header">
      ...
      <div class="clearfix">
       ...
       <tbody>
            ...
            ?>
            <tr>
              <td><?php echo utf8_encode($nombre_proyecto); ?></td>
              <td>x</td>
              
              <td>
              <a href="?controller=proyectos&&action=editar&&id=<?php echo $id; ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Proyecto">
                <i class="fa fa-edit bigger-110 "></i>
              </a>
              <a href="#" onclick="eliminar(<?php echo $id; ?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar Proyecto">
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=proyectos&&action=eliminar&&id="+id;
else
