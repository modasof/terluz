...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Editar Vehículo Publicado</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
            <li class="breadcrumb-item active"><a href="?controller=Nuevoshome&&action=todos">Publicados Inicio</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
					...
					<div class="row">
						...
						<div class="col-md-12">
						  ...
						  <div class="card card-primary">
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="?controller=Nuevoshome&&action=actualizar&&id=<?php echo $id;?>" method="POST" enctype="multipart/form-data">
							  <div class="card-body">
								<div class="card-header">
								  <h3 class="card-title">Seleccionar el Vehículo</h3>
								</div>
							<div class="row">
											<div class="col-md-6">
								 ...
								 <div  class="col-12">
									<div class="form-group">
									  ...
									  <div class="input-group">
										...
										<input type="text" name="version" value="<?php echo $publicados_home; ?>" class="form-control" id="color" placeholder="Ingrese el nombre de la versión" maxlength="100" required>
									  </div>
									</div>
								  </div>
							</div>
