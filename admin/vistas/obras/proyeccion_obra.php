...
$sqlcantidadesproyectadas = Obras::sqlproyeccionpor($id_actividad,$id_rango_act);
  if ($sqlcantidadesproyectadas>0) {
   ...
   if ($cantidadesfinalesredondeadas!=0) {
       // Mostrar botón de agregar 
    ?>
      <label><a data-toggle="modal" data-target="#modal-form<?php echo utf8_decode($id_rango_act); ?>-<?php echo utf8_decode($id_actividad); ?>" href="#" class="success"><i class="fa fa-plus-square"></i></a></label>
<?php 
    }
 ?>
      <?php 
    ...
    <div id="modal-form<?php echo utf8_decode($id_rango_act); ?>-<?php echo utf8_decode($id_actividad); ?>" class="modal" tabindex="-1">
               <!-- Inicio Modal -->
    <div>
    
<form action="?controller=obras&&action=guardarcantidadesproyectadas&&id=<?php echo($getobra); ?>" method="post" autocomplete="off">
    ...
    <input type="hidden" name="rango_id_rango" value="<?php echo($id_rango_act);?>">
                    ...
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="black bigger">
                          ...
                          <br><br>
                          Cantidad Final:<?php echo utf8_decode(number_format($cantidadesfinales, 2)." - ".$nomunidad); ?>
                          <br><br>
                          Proyección para el Rango-<?php echo utf8_decode($mes_numero_act." Iniciando desde el ".$fecha_inicio_act." finalizando el ".$fecha_fin_act); ?>
                        </h4>
                      </div>
                      ...
                      <div class="col-md-12 col-xs-12">
                          ...
                          <input type="number" step="any" name="cantidad_proyectada" placeholder="Cantidades Proyectadas" class="form-control" required value="">
...
?>
       <a href="#" onclick="eliminar(<?php echo $id_actividad; ?>,<?php echo $getobra; ?>,<?php echo $id_rango_act; ?>);" class="pull-right tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar">
