...
include_once 'controladores/clientesController.php';
  ...
  $cuentas = Ingresoscuenta::obtenerCuentapor($CuentaSel);
      
      foreach($cuentas as $caja){
      $id_cuenta = $caja['id_cuenta'];
      $nombre_cuenta = $caja['nombre_cuenta'];
      }
  $Porcuentas="Movimiento a cuenta";
  $PorFactura="Factura";
  $PorBanco="Prestamo Bancario";
  $PorOtros="Otros";
  $ingresosporcuentas=Ingresoscuenta::IngresosPortipo($CuentaSel,$Porcuentas);
  $ingresosporfactura=Ingresoscuenta::IngresosPortipo($CuentaSel,$PorFactura);
  $ingresosporbancos=Ingresoscuenta::IngresosPortipo($CuentaSel,$PorBanco);
  $ingresosporotros=Ingresoscuenta::IngresosPortipo($CuentaSel,$PorOtros);

  $totalotros= $ingresosporbancos+$ingresosporotros;
  $totalingresos=$ingresosporcuentas+$ingresosporfactura+$ingresosporbancos+$ingresosporotros;
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Ingresos <?php echo utf8_encode($nombre_cuenta) ?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=cuentas&&action=todos">Cuentas</a></li>
            <li class="breadcrumb-item active">Ingresos Cuenta </li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div style="display: none;" class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Por Cuentas</span>
              <span class="info-box-number"><?php Echo utf8_encode("$ ".number_format($ingresosporcuentas));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Por Facturas</span>
              <span class="info-box-number"><?php Echo utf8_encode("$ ".number_format($ingresosporfactura));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Otros Ingresos</span>
              <span class="info-box-number"><?php Echo utf8_encode("$ ".number_format($totalotros));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Total Ingresos Cuenta</span>
              <span class="info-box-number"><?php Echo utf8_encode("$ ".number_format($totalingresos));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
       ...
       <div class="row">
        <form action="?controller=ingresoscuenta&&action=ingresosporfecha&&id_cuenta=<?php echo($CuentaSel) ?>" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
    ...
    <div class="card card-default">
      ...
      <div class="clearfix">
          ...
          <tbody>
            <?php
             if ($fechaform!="") {
              $res=Ingresoscuenta::ReporteIngresosporfecha($FechaStart,$FechaEnd,$CuentaSel);
            ...
            $id_ingreso_cuenta = $campo['id_ingreso_cuenta'];
            $ingreso_por = $campo['ingreso_por'];
            $cuenta_aportante= $campo['cuenta_aportante'];
            ...
            $factura_num = $campo['factura_num'];
            $observaciones = $campo['observaciones'];
            $marca_temporal = $campo['marca_temporal'];
            $ingreso_por_cuentas = $campo['ingreso_por_cuentas'];
            $cuenta1=Ingresoscuenta::obtenerNombrecuenta($cuenta_aportante);
            $cuenta2=Ingresoscuenta::obtenerNombrecuenta($cuenta_id_cuenta);
           
            
            if ($cuenta_aportante==0) {
             $origen="";
            }
            else{
              $cuentaaportante=Ingresoscuenta::obtenerNombrecuenta($cuenta_aportante);
               $origen="CTA. ".$cuentaaportante;
            }

            if ($ingreso_por=="Factura") 
            {
               $factorigen=Clientes::obtenerNombreCliente($factura_num);
            }
            else
            {
              $factorigen="";
            ...
            <tr>
              ...
              <td><?php echo utf8_encode($ingreso_por) ?></td>
              <td><?php echo utf8_encode($bla) ?></td>
              ...
              <?php 
              if ($ingreso_por=="Movimiento a cuenta") {
                $soporteexterno=Ingresoscuenta::obtenerSoporte($ingreso_por_cuentas);
               ?>
            <a  onclick="hizoClick('<?php echo($cuenta1); ?>','<?php echo($cuenta2); ?>')" href="?controller=egresoscuenta&&action=editarcu&&id=<?php echo $ingreso_por_cuentas; ?>&&id_cuenta=<?php echo($id_cuenta); ?>" class="tooltip-primary text-danger" title="Editar Egreso">
                <i class="fa fa-edit bigger-110 "></i>
              </a>
           <a target="_blank" href="<?php echo($soporteexterno); ?>"  class="tooltip-primary text-danger" title="Ver Soporte">
                <i class="fa fa-eye bigger-110 "></i>
              </a>
           <a download="Soporte" href="<?php echo($soporteexterno); ?>"  class="tooltip-primary text-danger" title="Descargar Soporte">
                <i class="fa fa-cloud-download bigger-110 "></i>
              </a>
          
           <a href="#" onclick="eliminarmvs(<?php echo $ingreso_por_cuentas; ?>,<?php echo $id_ingreso_cuenta; ?>,<?php echo $CuentaSel ?>);" class="tooltip-primary text-danger"  title="Eliminar Ingreso  - Egreso">
            ...
            <?php 
              ...
              {
                ?>
                 <a href="?controller=ingresoscuenta&&action=editar&&id=<?php echo $id_ingreso_cuenta; ?>&&id_cuenta=<?php echo($cuenta_id_cuenta); ?>" class="tooltip-primary text-dark" title="Editar Egreso">
                <i class="fa fa-edit bigger-110 "></i>
              </a>
           
               <a target="_blank" href="<?php echo($imagen); ?>"  class="tooltip-primary text-dark" title="Ver Soporte">
                <i class="fa fa-eye bigger-110 "></i>
              </a>
           ...
           <a href="#" onclick="eliminar(<?php echo $id_ingreso_cuenta; ?>,<?php echo $CuentaSel ?>);" class="tooltip-primary text-dark"  title="Eliminar Ingreso">
                <i class="fa fa-trash bigger-110 "></i>
              </a>
             ...
             ?>
            <script>
              function hizoClick(cuenta1,cuenta2)
              {
                alert("Este movimiento afectará dos cuentas \n"+cuenta1+"\n"+cuenta2);
              }
            </script>
...
<script>
function eliminar(id,CuentaSel){
   eliminar=confirm("¿Deseas eliminar este registro?");
   if (eliminar)
     window.location.href="?controller=ingresoscuenta&&action=eliminar&&id="+id+"&&id_cuenta="+CuentaSel+"";
else
...
function eliminarmvs(idegreso,idingreso,cuentasel){
   eliminar=confirm("¿Deseas eliminar este registro?");
   alert("Esta acción Eliminará el registro en las dos cuentas");
   if (eliminar)
