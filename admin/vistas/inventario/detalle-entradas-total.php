...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Detalle Entrada</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
      ...
      <div class="row">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Detalle Entrada</h3>
...
foreach ($campos as $campo) {
    $id                     = $campo['id'];
    $cotizacion_item_id     = $campo['cotizacion_item_id'];
    $oc_id                  = $campo['oc_id'];
    $insumo_id              = $campo['insumo_id'];
    $cantidad               = $campo['cantidad'];
    $entrada_id             = $campo['entrada_id'];
    $fecha_registro         = $campo['fecha_registro'];
    $fecha_registro         = $campo['fecha_registro'];
    $estado_detalle_entrada = $campo['estado_detalle_entrada'];
    $marca_temporal         = $campo['marca_temporal'];
    $creado_por             = $campo['creado_por'];
    $entrada_por            = $campo['entrada_por'];

    if ($oc_id=='') {
        $detalleorigen='No aplica';
        $valorunitario=0;
        $totalvalor=0;
    }
    else{
        $idproveedor= Compras::obteneridproveedorcompra($oc_id);
        $valorunitario= Compras::obtenervalorcotizado($insumo_id,$cotizacion_item_id,$idproveedor,'2');
        $totalvalor=$valorunitario*$cantidad;
        $nombreproveedor= Proveedores::obtenerNombreProveedor($idproveedor);
        $detalleorigen=$nombreproveedor."<br><a href='?controller=compras&&action=verdetalle&&id=".$oc_id."'>OcN.".$oc_id."</a>";
    ...
    ?>
            <tr>
             <td><?php echo ($id) ?></td>
              <td><?php echo ($entrada_por) ?></td>
              <td><?php echo ($detalleorigen) ?></td>
               <td><a target="_blank" href="?controller=inventario&&action=entradasdetalle&&id=<?php echo($entrada_id); ?>"><?php echo utf8_encode($entrada_id); ?></a></td>
              <td><?php echo utf8_encode($nombrerecibe); ?></td>
               ...
               <td><?php echo utf8_encode($nominsumo); ?></td>
                ...
                <td><?php echo utf8_encode("$".number_format($valorunitario)); ?></td>
               <td><?php echo utf8_encode("$".number_format($totalvalor)); ?></td>
