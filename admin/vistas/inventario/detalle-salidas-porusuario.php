...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="m-0 text-dark">Despachos Recibidos por <?php echo ($nombre_usuario); ?></h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
            <li class="breadcrumb-item"><a href="?controller=inventario&&action=insumosrecibidospor&&id=<?php echo($IdSesion); ?>">Insumos Recibidos</a></li>
...
for ($i = 0; $i < $min; $i++) {
    ...
    $res2 = Inventario::totalrecibidoporentrega($Cadena[$i]);
