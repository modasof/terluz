...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Reporte Entradas Centro de Distribución</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
      ...
      <div class="row">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Entradas a Centro de Distribución  </h3>
        ...
        <form action="?controller=inventario&&action=entradasporfecha" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
...
if ($fechaform != "") {
    ?>
           <h3 class="m-0 text-dark">Reporte Entradas del <?php echo (fechalarga($datofechain)); ?> al <?php echo (fechalarga($datofechafinal)); ?></h3>
          <?php
}
?>
        </div><!-- /.col -->
...
if ($fechaform != "") {
    ...
    foreach ($campos as $campo) {
        $id_entrada_ins = $campo['id_entrada_ins'];
        ...
        ?>
            <tr>
             <td><?php echo ($id_entrada_ins) ?></td>
              <td><?php echo ($marca_temporal) ?></td>
              <td><?php echo ($nombrerecibe) ?></td>
              <td><?php echo utf8_encode($tipo_entrada); ?></td>
            <td><?php echo utf8_encode($observaciones); ?></td>
            <td><a target="_blank" href="?controller=inventario&&action=entradasdetalle&&id=<?php echo($id_entrada_ins); ?>">Ver Detalle</a></td>
