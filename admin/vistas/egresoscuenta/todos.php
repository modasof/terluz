...
<div class="content-wrapper">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Egresos Cuenta </li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <div class="content">
    <div style="display: none;" class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Préstamos a otras Cuentas</span>
              <span class="info-box-number"><?php Echo utf8_encode("$ ".number_format($egresosacuentas));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Egresos a Cajas</span>
              <span class="info-box-number"><?php Echo utf8_encode("$ ".number_format($egresosacajas));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Otros Egresos</span>
              <span class="info-box-number"><?php Echo utf8_encode("$ ".number_format($egresosaotros));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Total Egresos Cuenta</span>
              <span class="info-box-number"><?php Echo utf8_encode("$ ".number_format($totalegresos));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
    ...
    <div class="card card-default">
      <div class="card-body">
                                    <div class="row">
        <form action="?controller=egresoscuenta&&action=egresosporfecha&&id_cuenta=<?php echo($CuentaSel); ?>" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
      ...
      <div class="clearfix">
          ...
          <tbody>
           ...
           if ($fechaform!="") {
              $res=Egresoscuenta::obtenerEgresosporfecha($CuentaSel,$FechaStart,$FechaEnd);
           ...
           elseif ($cuenta_beneficiada!=0) {
             ...
             elseif ($proveedor_id_proveedor!=0) {
              $nombrebeneficiario=Proveedores::obtenerNombreProveedor($proveedor_id_proveedor);
            }
            elseif ($id_rubro!=0) {
            ...
            <tr>
              ...
              <td><?php echo utf8_encode($tipo_egreso) ?>
                <br>
                Registro Nº. <?php echo($id_egreso_cuenta); ?>
              </td>
