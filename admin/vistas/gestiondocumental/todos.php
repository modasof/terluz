...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="m-0 text-dark">Documentación Predeterminada <?php echo utf8_encode($Nombrecuenta); ?></h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
     ...
     <div class="col-lg-12">
          ...
          <tbody>
            ...
            $nombredocumento=Gestiondocumental::ObtenerNombredocumento($id_documento);
            $imagen=Gestiondocumental::DocumentoExiste($id_documento,$id_cuenta,$modulo_id_modulo);
            $idregistro=Gestiondocumental::DocumentoRegistro($id_documento,$id_cuenta,$modulo_id_modulo);
            $fechaexpira=Gestiondocumental::DocumentoFechaExpira($id_documento,$id_cuenta,$modulo_id_modulo);
            $alerta=Gestiondocumental::DocumentoAlerta($id_documento,$id_cuenta,$modulo_id_modulo);
            $marca=Gestiondocumental::DocumentoMarcatemporal($id_documento,$id_cuenta,$modulo_id_modulo);
            $Estado=Gestiondocumental::DocumentoEstado($id_documento,$id_cuenta,$modulo_id_modulo);
               ...
               <td></td>
                <td></td>
                 <td></td>
                  <td></td>
                   <td>
                      <button type="button" class="btn btn-default btn-flat"> <a  href="?controller=gestiondocumental&&action=nuevo&&modulo_gestion=<?php echo($modulo_gestion); ?>&&id_cuenta=<?php echo($id_cuenta); ?>"  class="tooltip-primary text-primary" title="Agregar">
                <i class="fa fa-plus bigger-100 "></i>
              </a>
            </button>
             <button type="button" class="btn btn-default btn-flat"> <a  href="?controller=gestiondocumental&&action=desactivarDocumento&&id=<?php echo($id_cuenta) ?>&&id_modulo=<?php echo($modulo_gestion); ?>&&id_documento=<?php echo($id_documento) ?>&&imagen=No-Aplica"  class="tooltip-danger text-danger" title="No Aplica">
           ...
           // No hace nada
            ...
            <button type="button" class="btn btn-default btn-flat"><a href="?controller=gestiondocumental&&action=editar&&idreg=<?php echo $idregistro;?>&&id_modulo=<?php echo($modulo_gestion); ?>&&id=<?php echo($id_cuenta); ?>" class="tooltip-primary text-success" title="Actualizar Documento">
                <i class="fa fa-edit bigger-110 "></i>
              </a>
             </button>
            <button type="button" class="btn btn-default btn-flat"> <a href="#" onclick="eliminar(<?php echo $idregistro; ?>,<?php echo($modulo_gestion) ?>,<?php echo($id_cuenta) ?>);" class="tooltip-primary text-danger" title="Eliminar Documento">
            ...
            ?>
              ...
              <div class="tab-pane" id="tab_2">
               <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                   <?php
            $res = Gestiondocumental::obtenerNodisponibles($id_cuenta);
            ...
            ?>
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                       <button type="button" class="btn btn-default btn-flat"> <a href="#" onclick="activar(<?php echo $id_registro; ?>,<?php echo($modulo_gestion) ?>,<?php echo($id_cuenta) ?>);" class="tooltip-primary text-success" title="Activar Documento">
...
function eliminar($id,$modulo,$cuenta){
   ...
   if (eliminar)
    //alert($modulo);
    window.location.href="?controller=gestiondocumental&&action=eliminar&&iddel="+$id+"&&id_modulo="+$modulo+"&&id="+$cuenta;
else
...
function activar($id,$modulo,$cuenta){
   ...
   if (eliminar)
    //alert($modulo);
    window.location.href="?controller=gestiondocumental&&action=activar&&iddel="+$id+"&&id_modulo="+$modulo+"&&id="+$cuenta;
else
  //Y aquí pon cualquier cosa que quieras que salga si le diste al boton de cancelar
