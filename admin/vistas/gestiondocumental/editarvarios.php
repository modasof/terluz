      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="?controller=gestiondocumental&&action=varios&&id_cuenta=<?php echo($id_cuenta); ?>">Varios</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
			...
			<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-12">
						  ...
						  <div class="card card-primary">
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="?controller=gestiondocumental&&action=actualizarvarios&&id=<?php echo $id; ?>&&id_cuenta=<?php echo($id_cuenta); ?>" method="POST" enctype="multipart/form-data">
								<?php  
										...
										<div class="form-group">
										  <label for="fila2_columna1">Actualizar Documento</label>
												<div class="custom-file">
													 <input name="imagen" type="file" id="input-file-now" class="dropify" data-default-file="<?php echo $imagen;?>" data-allowed-file-extensions="png jpg jpeg mp4 webm" data-show-errors="true" data-max-file-size="2M" data-errors-position="outside" accept="image/png, .jpeg, .jpg, image/gif,.pdf,.xlsx,.doc,.docs"/>
                ...
                <input type="text" name="nombre_documento" value="<?php echo utf8_encode($nombre_documento); ?>" class="form-control" id="nombre_documento" placeholder="Ingrese el nombre del rubro" maxlength="150" required>
								...
								<select class="form-control"  name="id_folder" required="" >
									<option value="<?php echo($id_folder); ?>" selected=""><?php echo($nombrefolder); ?></option>
													 	<?php
