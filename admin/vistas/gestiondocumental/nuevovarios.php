...
<link rel="stylesheet" href="plugins/dropify/dropify.min.css">
	...
	<div class="box box-primary collapsed-box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              	<form role="form" action="?controller=gestiondocumental&&action=guardarvarios&&id_cuenta=<?php echo($id_cuenta) ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
								<?php  
