...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Lista de Contratistas Mano de Obra (L-MO)</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
?>
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Listado Contratistas Mano de Obra </h3>
          ...
          <thead>
            ...
            <th >Unidad</th>
            <th >Valor Jornal</th>
            <th >Valor Salario Mensual <br>(Sin prestaciones)</th>
...
foreach ($campos as $campo) {
    $id_lmo            = $campo['id_lmo'];
    $nombre_lmo        = $campo['nombre_lmo'];
    $json['data']      = $campo;
    $unidad_id_unidad  = $campo['unidad_id_unidad'];
    $fecha_reporte     = $campo['fecha_reporte'];
    $valor_jornal      = $campo['valor_jornal'];
    $valor_mensual     = $campo['valor_mensual'];
    ...
    ?>
            <tr>
              ...
              <a href="?controller=listamo&&action=editar&&id=<?php echo $id_lmo; ?>&&vereditar=1" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar">
                <i class="fa fa-edit bigger-110 "></i>
              </a>
              <a href="#" onclick="eliminar(<?php echo $id_lmo; ?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar">
                <i class="fa fa-trash bigger-110 "></i>
              </a>
              </td>
              <td><?php echo ("LMO-" . $id_lmo); ?></td>
              <td><?php echo utf8_decode($nombre_lmo); ?></td>
              <td><?php echo utf8_decode($nomunidad); ?></td>
              <td><?php echo ("$" . number_format($valor_jornal, 0)); ?></td>
              <td><?php echo ("$" . number_format($valor_mensual, 0)); ?></td>
              <td><?php echo utf8_decode($nomusuario . "<br>" . $fecha_reporte); ?></td>
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=listamo&&action=eliminar&&id="+id;
else
