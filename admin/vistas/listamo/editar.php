...
$res    = Listamo::obtenerPaginaPor($idventa);
	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
						...
						<!-- left column -->
						<div class="col-md-8">
	<form role="form" autocomplete="off" action="?controller=listamo&&action=actualizar&&id=<?php echo ($idventa); ?>" method="POST" enctype="multipart/form-data"  id="formulario" name="formulario" onsubmit="return validateForm();">
								<?php
					...
					<div class="card-body">
                        ...
                        <div class="form-group">
                          <label for="nombres">Descripción</label>
                            <textarea class="form-control" rows="2" name="nombre_lmo" id="nombre_lmo" placeholder="Descripción" maxlength="500" required><?php echo utf8_decode($nombre_lmo); ?></textarea>
                        </div>
                </div>
                                ...
                                <?php }?>
										...
										<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" id="demo1" name="valor_jornal" placeholder="Valor Jornal" class="form-control" required value="<?php echo utf8_decode($valor_jornal); ?>">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" id="demo2" name="valor_mensual" placeholder="Valor Salario Mensual (Sin prestaciones)" class="form-control" required value="<?php echo utf8_decode($valor_mensual); ?>">
