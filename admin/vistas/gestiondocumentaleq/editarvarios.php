					...
					<div class="row">
						...
						<div class="col-md-12">
						  ...
						  <div class="card card-primary">
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="?controller=gestiondocumentaleq&&action=actualizarvarios&&id=<?php echo $id; ?>&&id_cuenta=<?php echo($id_cuenta); ?>" method="POST" enctype="multipart/form-data">
								<?php  
