    <?php 
    $res=Lineasnegocio::obtenerPagina();
$campos = $res->getCampos();

foreach($campos as $campo){
      $id = $campo['id'];
      $nombreunidad = $campo['nombre'];
     ?> 
   ...
   <div class="col-md-4 col-xs-12">
         ...
         <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Despachos <?php echo($nombreunidad); ?> <small> Actualizado al <?php
...
?></small></h3>
        ...
        <table  class="table table-responsive table-bordered table-hover dataTables_borderWrap" style="width: 100%;font-size: 12px;">
          <thead>
...
for ($i = 1; $i < $tope; $i++) {
    ...
    ?>
                <tr>
                  ...
                  <td>
                    <?php
$ventames133 = Despachosmesgeneral($i, $anoactual);
    $sumaventas133 += $ventames133;
    echo ("<a style='color:black;' href='?controller=reportes&&action=despachosclientes&daterange=" . $fechaconsulta . "'><small style='color:#128a2e;'></small> " . number_format($ventames133, 0) . "</a>");
...
?>
              <tr class="success">
                ...
                <td><strong><?php echo (number_format($sumaventas133, 0)) ?></strong></td>
                <td></td>
