...
for ($i = 1; $i < $tope; $i++) {
    ...
    ?>
                <tr>
                  ...
                  <td>
                    <?php
$ventames188 = Horasmqmesgeneral($i, $anoactual);
    $sumaventas188 += $ventames188;
    echo ("<a style='color:black;' href='?controller=reportes&&action=despachosclientes&daterange=" . $fechaconsulta . "'><small style='color:#128a2e;'></small> " . number_format($ventames188, 0) . "</a>");
...
?>
              <tr class="success">
                ...
                <td><strong><?php echo (number_format($sumaventas188, 0)) ?></strong></td>
                <td></td>
