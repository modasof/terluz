...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Subir Documento Prov. <?php echo utf8_encode($Nombrecuenta); ?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=gestiondocumentalprov&&action=listaequipos">Gestión Documental Proveedores</a></li>
              <li class="breadcrumb-item active"><a href="?controller=gestiondocumentalprov&&action=todos&&id=<?php echo($id_equipo) ?>&&id_modulo=<?php echo($modulo_gestion) ?>">Predeterminados</a></li> 
