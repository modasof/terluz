...
$Nombrecuenta=Gestiondocumentaleq::ObtenerNombreequipo($id_cuenta);
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="m-0 text-dark">Documentación (Varios) Eq.<?php echo utf8_encode($Nombrecuenta); ?></h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=gestiondocumentaleq&&action=listaequipos">Gestión Documental Equipos</a></li>
     ...
     <div class="col-lg-12">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo utf8_encode($nombre_documento); ?></td>
              <?php 
              if ($alerta=="Si") {
               ?>
             ...
             <button type="button" class="btn btn-default btn-flat"><a href="?controller=gestiondocumentaleq&&action=editarvarios&&id=<?php echo $id;?>&&id_cuenta=<?php echo($id_cuenta); ?>" class="tooltip-primary text-success" title="Actualizar Documento">
...
function eliminar($id,$cuenta){
   ...
   if (eliminar)
    //alert($modulo);
    window.location.href="?controller=gestiondocumentaleq&&action=eliminarvarios&&id="+$id+"&&id_cuenta="+$cuenta;
else
