...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="m-0 text-dark">Documentación Obligatoria <?php echo utf8_encode($Nombrecuenta); ?></h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Obligatorios</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <div class="content">
    ...
    <div class="card card-default">
      <div class="card-body">
          <!-- <a href="?controller=gestiondocumental&&action=nuevo&&modulo_gestion=<?php echo($modulo_gestion); ?>" class="btn btn-success" style="float: right;"><i class="fa fa-file-text-o bigger-110 "></i> Cargar Documento</a> -->
      ...
      <div class="clearfix">
          ...
          <thead>
            ...
            elseif ($modulo_id_modulo==2) {
              ...
              <td><?php echo utf8_encode($asociado); ?></td>
              <td><?php echo utf8_encode($nombredocumento); ?></td>
              <td><?php echo utf8_encode($alerta); ?></td>
                <td><?php echo utf8_encode($expira); ?></td>
							<td>
							<div class="btn-group">
               <button type="button" class="btn btn-default btn-flat"><a href="?controller=gestiondocumental&&action=editar&&id=<?php echo $id;?>&&id_modulo=<?php echo($modulo_gestion); ?>" class="tooltip-primary text-success" title="Actualizar Documento">
                <i class="fa fa-refresh bigger-110 "></i>
              </a>
             </button>
            <button type="button" class="btn btn-default btn-flat"> <a href="#" onclick="eliminar(<?php echo $id; ?>,<?php echo($modulo_gestion) ?>);" class="tooltip-primary text-danger" title="Eliminar Documento">
