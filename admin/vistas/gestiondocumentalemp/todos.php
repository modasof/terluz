...
$id_equipo = $_GET['id'];
$Nombrecuenta=Gestiondocumentalemp::ObtenerNombreFuncionario($id_equipo);
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=gestiondocumentalemp&&action=listaequipos">Gestión Documental Recursos Humanos</a></li>
    ...
    <div class="container-fluid">
     ...
     <div class="col-lg-12">
          ...
          <tbody>
            ...
            $nombredocumento=gestiondocumentalemp::ObtenerNombredocumento($id_documento);
            $imagen=gestiondocumentalemp::DocumentoExiste($id_documento,$id_equipo,$modulo_id_modulo);
            $idregistro=gestiondocumentalemp::DocumentoRegistro($id_documento,$id_equipo,$modulo_id_modulo);
            $fechaexpira=gestiondocumentalemp::DocumentoFechaExpira($id_documento,$id_equipo,$modulo_id_modulo);
            $alerta=gestiondocumentalemp::DocumentoAlerta($id_documento,$id_equipo,$modulo_id_modulo);
            $marca=gestiondocumentalemp::DocumentoMarcatemporal($id_documento,$id_equipo,$modulo_id_modulo);
            $Estado=gestiondocumentalemp::DocumentoEstado($id_documento,$id_equipo,$modulo_id_modulo);
               ...
               <td></td>
                <td></td>
                 <td></td>
                  <td></td>
                   <td>
                      <button type="button" class="btn btn-default btn-flat"> <a  href="?controller=gestiondocumentalemp&&action=nuevo&&modulo_gestion=<?php echo($modulo_gestion); ?>&&id_cuenta=<?php echo($id_equipo); ?>"  class="tooltip-primary text-primary" title="Agregar">
                <i class="fa fa-plus bigger-100 "></i>
              </a>
            </button>
             <button type="button" class="btn btn-default btn-flat"> <a  href="?controller=gestiondocumentalemp&&action=desactivarDocumento&&id=<?php echo($id_equipo) ?>&&id_modulo=<?php echo($modulo_gestion); ?>&&id_documento=<?php echo($id_documento) ?>&&imagen=No-Aplica"  class="tooltip-danger text-danger" title="No Aplica">
           ...
           // No hace nada
            ...
            <button type="button" class="btn btn-default btn-flat"><a href="?controller=gestiondocumentalemp&&action=editar&&idreg=<?php echo $idregistro;?>&&id_modulo=<?php echo($modulo_gestion); ?>&&id=<?php echo($id_equipo); ?>" class="tooltip-primary text-success" title="Actualizar Documento">
            ...
            ?>
              ...
              <div class="tab-pane" id="tab_2">
                ...
                <tbody>
                   <?php
            $res = gestiondocumentalemp::obtenerNodisponibles($id_equipo);
            ...
            foreach ($Inactivos as $mov){
              ...
              $nombredocumento=gestiondocumentalemp::ObtenerNombredocumento($documento_id_documento);
            ?>
                <tr>
                  <td><?php echo utf8_encode($nombredocumento); ?></td>
                  <td>
...
function eliminar($id,$modulo,$cuenta){
   ...
   if (eliminar)
    //alert($modulo);
    window.location.href="?controller=gestiondocumentalemp&&action=eliminar&&iddel="+$id+"&&id_modulo="+$modulo+"&&id="+$cuenta;
else
...
function activar($id,$modulo,$cuenta){
   ...
   if (eliminar)
    //alert($modulo);
    window.location.href="?controller=gestiondocumentalemp&&action=activar&&iddel="+$id+"&&id_modulo="+$modulo+"&&id="+$cuenta;
else
  //Y aquí pon cualquier cosa que quieras que salga si le diste al boton de cancelar
