...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Subir Documento <?php echo utf8_encode($Nombrecuenta); ?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=gestiondocumentalemp&&action=listaequipos">Gestión Documental Recursos Humanos</a></li>
              <li class="breadcrumb-item active"><a href="?controller=gestiondocumentalemp&&action=todos&&id=<?php echo($id_equipo) ?>&&id_modulo=<?php echo($modulo_gestion) ?>">Predeterminados</a></li> 
					...
					<div class="row">
						...
						<div class="col-md-12">
						  ...
						  <div class="card card-primary">
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="?controller=gestiondocumentalemp&&action=guardar&&id_modulo=<?php echo($modulo_gestion) ?>&&id=<?php echo($id_equipo); ?>" method="POST" enctype="multipart/form-data">
								<?php  
									...
									<div class="form-group">
											<label for="sel1">Tipo Documento:<span>*</span></label>
														  <select class="form-control"  name="documento_id_documento" >
																...
																<?php
																	$cajas = Gestiondocumentalemp::obtenerDocumentos($modulo_gestion);
