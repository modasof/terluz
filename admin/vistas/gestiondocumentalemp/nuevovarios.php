...
<link rel="stylesheet" href="plugins/dropify/dropify.min.css">
	...
	<div class="box box-primary collapsed-box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              	<form role="form" action="?controller=gestiondocumentalemp&&action=guardarvarios&&id_cuenta=<?php echo($id_cuenta) ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
								<?php  
										...
										<div class="form-group">
										  <label for="fila2_columna1">Seleccione el documento <small>Tamaño máximo 20MB</small></label>
												<div class="custom-file">
													  <input name="imagen" type="file" id="input-file-now" class="dropify" data-default-file=""  multiple="multiple" data-allowed-file-extensions="png jpg jpeg mp4 pdf xls xlsx webm doc docs" data-show-errors="true" data-max-file-size="20M" data-errors-position="outside" accept="image/png, .jpeg, .jpg, image/gif,.pdf,.xlsx,.doc,.docs"/ required>
												</div>
										</div>
									   </div>
									    <div class="col-md-4">
												<div class="form-group">
													<label>Seleccione Folder: <span>*</span></label>
								<select class="form-control"  name="id_folder" required="" >
...
foreach($campos2 as $campo2){
            ...
            $nombre_folder = $campo2['nombre_folder'];
                ?>
                	<option value="<?php echo($idfolder) ?>"><?php echo utf8_encode($nombre_folder) ?></option>
                ...
                <input type="text" name="nombre_documento" value="" class="form-control" id="nombre_documento" placeholder="Ingrese el nombre del documento" maxlength="150" required>
								  ...
								  <div style="display: none;" class="col-sm-4">
												...
												<div class="form-group">
													<label>Fecha Documento: <span>*</span></label>
													<input type="date" name="fecha_documento" placeholder="Fecha del documento" class="form-control"  id="fecha_documento">
												</div>
