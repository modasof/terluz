...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Editar Tipo Mantenimiento</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
            <li class="breadcrumb-item active"><a href="?controller=campamento&&action=todos">Tipo Mantenimiento</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
									 ...
									 <div class="col-md-4">
										<div class="form-group">
										  ...
										  <div class="input-group">
							                ...
							                <input type="text" name="nombre_tipomantenimiento" value="<?php echo utf8_encode($nombre_tipomantenimiento);?>" class="form-control" id="nombre_tipomantenimiento" placeholder="Ingrese el nombre del Tipo Mantenimiento" maxlength="150" required>
							              </div>
									  ...
									  <div class="col-md-4">
										<div class="form-group">
										  ...
										  <div class="input-group">
							                <span class="input-group-addon"><i class="fa fa-check"></i></span>
							                <input type="text" name="tipo_tipomantenimiento" value="<?php echo utf8_encode($tipo_tipomantenimiento);?>" class="form-control" id="tipo_tipomantenimiento" placeholder="Ingrese el Tipo Mantenimiento">
							              </div>
