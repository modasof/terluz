...
include_once 'vistas/index/header-formdate.php';
 ...
 $nombrecuenta   = Cajas::obtenerNombreCaja($CuentaSel);
  $nombrerubro = Rubros::obtenerNombreRubro($RubroSel);
   $egresosrubro = Informes::SumaEgresosportipocaja($FechaStart,$FechaEnd,$CuentaSel,$RubroSel);
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
             ...
             <li class="breadcrumb-item"><a href="?controller=informes&&action=movimientoscajas&&id_caja=<?php echo($CuentaSel); ?>">Movimientos Caja<?php echo($nombrecuenta); ?></a></li>
  ...
  <div class="content">
    <div class="container-fluid">
      ...
      <div class="card card-dark">
         ...
         <form action="?controller=informes&&action=subrubrosegresoscaja&&id_caja=<?php echo($CuentaSel) ?>&&id_rubro=<?php echo($RubroSel); ?>" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
...
?>
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
          ...
          <tbody>
            <?php
            if ($fechaform!="") {
              $res=Informes::ListaEgresosSubrubrocaja($FechaStart,$FechaEnd,$CuentaSel,$RubroSel);
             ;
            }
            else
            {
            ...
            $totalegresos = Informes::SumaEgresosporsubrubrocaja($FechaStart,$FechaEnd,$CuentaSel,$subrubrocuenta);
            $porcentajeegresos=($totalegresos/$egresosrubro)*100;
            
            ?>
            <tr>
              
              <td><a href="?controller=gastos&&action=egresosporsubrubro&&id_caja=<?php echo($CuentaSel); ?>&&id_subrubro=<?php echo($subrubrocuenta); ?>"><?php echo $nombresubrubro; ?></a></td>
              <td>
