...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4 class="m-0 text-dark">Informe Compras</h4>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
foreach ($campos as $campo) {
    ...
    ?>
            <tr>
              ...
              <td><a href="?controller=informes&&action=movimientoscaja&&id_caja=<?php echo ($id_caja) ?>"><i class="fas fa-list-alt"> </i> <?php echo $nombre_proveedor; ?></a></td>

          <?php 
          //if ($saldo>=0) {
            //echo("<td>$".number_format(0)."</td><td class='bg-success'>$".number_format($saldo,0)."</td>");
          //}else{
            //echo("<td class='bg-danger'>$".number_format($saldo,0)."</td><td>$".number_format(0)."</td>");
         // }
           ?><td>.</td>
