...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4 class="m-0 text-dark">Informe Cajas</h4>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
foreach ($campos as $campo) {
    ...
    ?>
            <tr>
              ...
              <td><a href="?controller=informes&&action=movimientoscaja&&id_caja=<?php echo ($id_caja) ?>"><i class="fas fa-list-alt"> </i> <?php echo $nombre_caja; ?></a></td>
              <td>
                <?php echo utf8_encode("$" . number_format($saldofinal)); ?>
              </td>
              <td>
                 <a class="btn btn-danger btn-sm" href="?controller=gastos&&action=egresos&&id_caja=<?php echo ($id_caja) ?>"><i class="fas fa-sign-out-alt"></i></a>
              </td>
            </tr>
            <?php
}
