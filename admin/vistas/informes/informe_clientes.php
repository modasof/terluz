...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4 class="m-0 text-dark">Informe Clientes</h4>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
foreach ($campos as $campo) {
    ...
    $nombre_cliente        = $campo['nombre_cliente'];
      ...
      $transporte=VentasFleteCliente($id_cliente);
      $material=VentasMaterialCliente($id_cliente);
      $concreto=VentasConcretoCliente($id_cliente);

      $totalventas=$transporte+$material+$concreto;
      $totalabonos=AbonosCliente($id_cliente);
      $saldo=$totalabonos-$totalventas;
    ?>
            <tr>

              <td><a href="?controller=informes&&action=movimientoscaja&&id_caja=<?php echo ($id_caja) ?>"><i class="fas fa-list-alt"> </i> <?php echo $nombre_cliente; ?></a></td>
