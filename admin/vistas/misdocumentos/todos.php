...
<div class="content-wrapper">
  ...
  <div class="content">
    ...
    <div class="card card-default">
      <div class="card-body">
          <a href="?controller=misdocumentos&&action=nuevo&&IdSesion=<?php echo($IdSesion); ?>" class="btn btn-success" style="float: right;"><i class="fa fa-file-text-o bigger-110 "></i> Cargar Documento</a>
      ...
      <div class="clearfix">
          ...
          <thead>
            <tr style="background-color: #4f5962;color: white;">
               ...
               <th>Acciones</th>
               <th>Documento</th>
              <th>Actualizado el aaaa/mm/dd </th>
              <th>Alerta</th>
            ...
            else
            {
             ...
             <button type="button" class="btn btn-default btn-flat"> <a download="Soporte" href="<?php echo($imagen); ?>"  class="tooltip-primary text-dark" title="Descargar Soporte">
               ...
               <button type="button" class="btn btn-default btn-flat"><a href="?controller=misdocumentos&&action=editar&&id=<?php echo $id;?>&&id_usuario=<?php echo($IdSesion); ?>" class="tooltip-primary text-success" title="Actualizar Documento">
                <i class="fa fa-edit bigger-110 "> </i>
              </a>
             </button>
            <button type="button" class="btn btn-default btn-flat"> <a href="#" onclick="eliminar(<?php echo $id; ?>,<?php echo($IdSesion) ?>);" class="tooltip-primary text-danger" title="Eliminar Documento">
              ...
              <td><a target="_blank" href="<?php echo($imagen); ?>"><?php echo utf8_encode($nombre_documento); ?></a></td>
              <td><?php echo utf8_encode($marca_temporal); ?></td>
              <td><?php echo utf8_encode($alerta); ?></td>
                <td><?php echo utf8_encode(fechalarga($expira)); ?></td>
...
function eliminar($id,$modulo){
   ...
   if (eliminar)
    //alert($modulo);
    window.location.href="?controller=misdocumentos&&action=eliminar&&id="+$id+"&&id_usuario="+$modulo;
else
