...
<div class="content-wrapper">
  ...
  <div class="content">
    ...
    <div class="card card-primary">
      <div class="card-body">
          <a  href="?controller=vehiculos&&action=crearnuevo" class="btn btn-success" style="float: right;display: none;"><i class="fa fa-file-text-o bigger-110 "></i> Crear Vehiculo Nuevo</a>
          <br><br>
          ...
          <tbody>
            ...
            $url = $campo['url'];
              ...
              <td><?php echo $seccion; ?></td>
                ...
                {
                  ?>
                   <img src="<?php echo $imagen; ?>" height="50" width="250">
                  <?php
                }
                 ...
                 ?>
							...
							<td class="text-center"><?php echo $clicks; ?></td>
              <td class="text-center"><?php echo $url; ?></td>
							<td>
							<a href="?controller=publicidad&&action=editar&&id=<?php echo $id; ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Publicidad">
								<i class="fa fa-edit bigger-110 "></i>
							</a>
               <a href="#" onclick="publicar(<?php echo $id; ?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Resetear Clicks">
                <i class="fa fa-refresh bigger-100 "> Resetear Clicks</i>						
...
function publicar(id){
   eliminar=confirm("¿Deseas resetear los clicks de esta publicidad?");
   if (eliminar)
     window.location.href="?controller=publicidad&&action=publicar&&id="+id+"&&tipopublicar=Nuevo";
else
  //Y aquí pon cualquier cosa que quieras que salga si le diste al boton de cancelar
    alert('No se ha podido resetear el registro...')
}
</script>
