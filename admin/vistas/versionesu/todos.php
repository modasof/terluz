...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Versiones Usados</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
 ...
 <div class="content">
    ...
    <div class="card card-primary">
      <div class="card-body">
          <a href="?controller=versionesu&&action=nuevo" class="btn btn-success" style="float: right;"><i class="fa fa-plus-square bigger-110 "></i> Crear Versión Usado</a>
          <br><br>
    ...
    <!--  <div class="card-header">
      ...
      <tbody>
            ...
            $modelo = Versiones::obtenerModeloPor($id_modelo);
            $id_marca = $campo['id_marca'];
            $marca = Versiones::obtenerMarcaPor($id_marca);
            ...
            <tr>
              ...
              <td>
              <a href="?controller=versionesu&&action=editar&&id=<?php echo $id; ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Version">
                <i class="fa fa-edit bigger-110 "></i>
              </a>
              <a href="#" onclick="eliminar(<?php echo $id; ?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar Version">
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=versionesu&&action=eliminar&&id="+id;
else
