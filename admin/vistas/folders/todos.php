...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Carpetas</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <div class="content">
    ...
    <div class="card card-primary">
      <div class="card-body">
          <a href="?controller=folders&&action=nuevo" class="btn btn-success" style="float: right;"><i class="fa fa-plus-square bigger-110 "></i> Crear Carpeta</a>
          <br><br>
    ...
    <!--  <div class="card-header">
      ...
      <div class="clearfix">
       ...
       <tbody>
            <?php
             if ($tipo!="") {
              $res=folders::obtenerPaginaportipo($tipo);
            ...
            ?>
            <tr>
              <td><?php echo utf8_encode($categoria_ppal); ?></td>
              <td><?php echo utf8_encode($nombre_folder); ?></td>
              <td>
              <a href="?controller=folders&&action=editar&&id=<?php echo $id; ?>&&tipo=<?php echo($tipo); ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Carpeta">
                <i class="fa fa-edit bigger-110 "></i>
              </a>
              <a href="#" onclick="eliminar(<?php echo $id; ?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar Carpeta">
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=folders&&action=eliminar&&id="+id;
else
