...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Nuevo Testimonio</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
					...
					<div class="row">
						...
						<div class="col-md-12">
						  ...
						  <div class="card card-primary">
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="?controller=testimonios&&action=guardarTestimonio" method="POST" enctype="multipart/form-data">
							  <div class="card-body">
												...
												<div class="form-group">
												  ...
												  <div class="input-group">
													<div class="input-group-prepend">
													  ...
													  <textarea class="form-control" rows="4" name="testimonio" id="testimonio" placeholder="Ingrese el testimonio del cliente" required></textarea>
												  </div>
												</div>
											  </div>
										  </div>
