...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Informe Recepción de Arena</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
            <li class="breadcrumb-item"><a href="?controller=index&&action=informedetalleclientes&&elcliente=39">Volver</a></li>
	...
	<div class="content">
		<div class="container-fluid">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
            	            <div class="row">
        <form action="?controller=reportes&&action=despachosporfechaproveedorunico&&elproveedor=<?php echo($elproveedor); ?>" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
       ...
       <div class="col-sm-12">
        ...
        if ($fechaform!="") {
          ?>
           <h3 class="m-0 text-dark">Reporte Recepción Arena del <?php echo(fechalarga($datofechain)) ?> al <?php echo (fechalarga($datofechafinal)) ?></h3>
          <?php
        }
        else
        {
          ?>
           <h3 class="m-0 text-dark">Reporte Total Recepción Arena </h3>
          <?php
        }
       ...
       <tbody>
            <?php
            if ($fechaform!="") {
              $res=Reportes::ReporteDespachosporfechaproveedorunico($FechaStart,$FechaEnd,$elproveedor);
            ...
            $nomprov=Proveedores::obtenerNombreInsumo($proveedor_id_proveedor);
            ...
            <tr>
             ...
             <a download="Soporte" href="<?php echo($imagen); ?>"  class="tooltip-primary text-dark" title="Descargar Soporte">
              ...
              <td><?php echo utf8_encode($nomprov); ?></td>
