...
<div class="content-wrapper">
	...
	<div class="content">
		<div class="container-fluid">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
            	            <div class="row">
        <form action="?controller=reportes&&action=despachosporfechapropietario" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
       ...
       <tbody>
            ...
            $nompropietario=Equipos::obtenerPropietarioEquipo($equipo_id_equipo);
