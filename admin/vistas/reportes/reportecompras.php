...
<div class="content-wrapper">
	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
            	...
            	require_once 'formreportecompra.php';
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
            	            <div class="row">
        <form action="?controller=reportes&&action=comprasporfecha" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
       ...
       <div class="col-sm-12">
        ...
        if ($fechaform!="") {
          ?>
           <h3 class="m-0 text-dark">Reporte Compras del <?php echo(fechalarga($datofechain)) ?> al <?php echo (fechalarga($datofechafinal)) ?></h3>
          <?php
        }
        else
        {
          ?>
           <h3 class="m-0 text-dark">Reporte Total Compras </h3>
          <?php
        }
       ...
       <tbody>
            <?php
            if ($fechaform!="") {
              $res=Reportes::ReporteComprasporfecha($FechaStart,$FechaEnd);
            ...
            <tr>
              <td>
              <a href="?controller=reportes&&action=editarcompra&&id=<?php echo $id; ?>&&vereditar=1" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Compra">
              ...
              <td><?php echo utf8_encode($pago_con); ?></td>
...
<form action="?controller=reportes&&action=insumoextra&&tiporeporte=1" method="post" autocomplete="off">
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=reportes&&action=eliminarcompra&&id="+id;
else
