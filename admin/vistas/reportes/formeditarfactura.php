...
$res=Reportes::editarfacturaPor($idventa);
...
foreach($campos as $campo){
 ...
 $Sumaabonos=obtenerAbonosPor($idventa);
 $SaldoPendiente=$valor_total-$Sumaabonos;
?>
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Editar Factura
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="?controller=reportes&&action=facturas">Reporte Facturas</a></li>
		...
		<div class="container-fluid">
			<div class="row">
					...
					<div class="col-md-12">
						...
						<!-- left column -->
						<div class="col-md-4">
	<form role="form" autocomplete="off" action="?controller=reportes&&action=actualizarfactura&&id=<?php echo($idventa); ?>" method="POST" enctype="multipart/form-data" >
							<?php  
										...
										<div class="form-group">
										  <label for="fila2_columna1">Actualizar Documento</label>
												<div class="custom-file">
													 <input name="imagen" type="file" id="input-file-now" class="dropify" data-default-file="<?php echo $imagen;?>" data-allowed-file-extensions="png jpg jpeg mp4 pdf xls xlsx webm" data-show-errors="true" data-max-file-size="10M" data-errors-position="outside" accept="image/png, .jpeg, .jpg, image/gif,.pdf,.xlsx"/>
										...
										<?php } ?>
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" name="valor_total" placeholder="Valor Total" class="form-control" id="demo1" value="<?php echo($valor_total);?>">
												</div>
											</div>
...
<div class="col-md-8">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Total Factura</span>
              <span class="info-box-number"><?php Echo utf8_encode("$ ".number_format($valor_total));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php Echo utf8_encode("$ ".number_format($Sumaabonos));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php Echo utf8_encode("$ ".number_format($SaldoPendiente));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
  ...
  <form role="form" autocomplete="off" action="?controller=reportes&&action=guardarabono&&id=<?php echo($idventa); ?>" method="POST" enctype="multipart/form-data" >
							<?php  
								date_default_timezone_set("America/Bogota");
								$TiempoActual = date('Y-m-d H:i:s');
							?>
					...
					<input type="hidden" name="reporte_id_factura" value="<?php echo($idventa);?>">

					
					 	<h3>Agregar Abono <button class="btn btn-success btn-sm">
														<i class="fa fa-plus-square"></i>
													</button></h3>
					  	<div class="col-md-6">
												<div class="form-group">
													<label>Fecha del Abono: <span>*</span></label>
													<input type="date" name="fecha_abono" placeholder="Fecha Abono" class="form-control required" required id="fecha_abono" value="">
												</div>
											</div>
							<div class="col-md-6">
												<div class="form-group">
													<label>Valor Abono<span>*</span></label>
													<input type="text" name="valor_abono" placeholder="Valor Abono" class="form-control" id="demo2" value="">
												</div>
						</div>
						</form>

		<!--Final Formulario Abonos-->
            ...
            <tr>
              ...
              <th>Valor</th> 
                            ...
                            <tbody>
                           <?php 
              $res=Reportes::ReporteAbonospor($idventa);
              $campos = $res->getCampos();
              foreach ($campos as $campo){
            $idabono = $campo['id'];
            ...
            $valor_abono = $campo['valor_abono'];
                            ...
                            <tr>
                            	<td>
                            		 <a href="#" onclick="eliminar(<?php echo $idabono; ?>,<?php echo($idventa) ?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar Abono">
                <i class="fa fa-trash bigger-110 "></i>
              </a>
                            	</td>
                            	<td><?php echo ($fecha_abono) ?></td>
                            	<td><?php echo utf8_encode("$".number_format($valor_abono,0)); ?></td>
                            </tr>
                           <?php 
                       }
                            ?>	
...
<script>
function eliminar(idabono,idsol){
   eliminar=confirm("¿Deseas eliminar este registro?");
   if (eliminar)
     window.location.href="?controller=reportes&&action=eliminarabono&&idabono="+idabono+"&&id="+idsol;
else
