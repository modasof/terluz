...
<div class="box box-primary ">
            <div class="box-header with-border">
              <h3 class="box-title"> Registrar Alquiler
            ...
            <!-- /.box-header -->
            <div class="box-body">
	<form role="form" autocomplete="off" action="?controller=reportes&&action=guardarprestamo" method="POST" enctype="multipart/form-data" >
							<?php  
					...
					<div class="card-body">
										...
										<?php } ?>
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" name="valor_prestamo" placeholder="Valor Alquiler" class="form-control" id="demo1">
												</div>
											</div>
							...
							<div class="row">
								<div class="card-footer">
								  <button name="Submit" type="submit" class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="Haz clic aqui para guardar la información">Reportar Alquiler</button>
								</div>
						  </div>
						  </form>
</div>
