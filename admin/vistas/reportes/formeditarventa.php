...
$res=Reportes::editarventaPor($idventa);
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Editar Venta</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
            <li class="breadcrumb-item"><a href="?controller=reportes&&action=ventas">Reporte Ventas</a></li>
	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
						...
						<!-- left column -->
						<div class="col-md-8">
	<form role="form" autocomplete="off" action="?controller=reportes&&action=actualizarventa&&id=<?php echo($idventa); ?>" method="POST" enctype="multipart/form-data" >
							<?php  
							...
							<div class="row">
									<div class="col-md-12">
												<div class="form-group">
													...
													<input type="number" step="" name="num_factura" placeholder="Número de Factura" class="form-control" required value="<?php echo($num_factura);?>">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
