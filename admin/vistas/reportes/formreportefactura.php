...
<div class="box box-primary ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
	<form role="form" autocomplete="off" action="?controller=reportes&&action=guardarfactura" method="POST" enctype="multipart/form-data" >
							<?php  
					...
					<div class="card-body">
							...
							<div class="row">
								<div class="col-md-12">
										<div class="form-group">
										  <label for="fila2_columna1"> <small>Tamaño máximo 10MB</small></label>
							...
							<div class="row">
								<div class="card-footer">
								  <button name="Submit" type="submit" class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="Haz clic aqui para guardar la información">Reportar Factura</button>
								</div>
						  </div>
						  </form>
</div>
