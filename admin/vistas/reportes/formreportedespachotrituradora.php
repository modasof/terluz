...
<div class="box box-primary ">
            <div class="box-header with-border">
              <h3 class="box-title"> Registro Trituradora
            ...
            <!-- /.box-header -->
            <div class="box-body">
	<form role="form" autocomplete="off" action="?controller=reportes&&action=guardardespachotrituradora" method="POST" enctype="multipart/form-data" >
							<?php  
					...
					<div class="card-body">
							<div class="row">
								...
								<select class="form-control" id="tipo_despacho" name="tipo_despacho" required>
										...
										<option value="Trituradora" selected="">Trituradora</option>
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="number" step="any" name="cantidad" placeholder="Indique la cantidad" class="form-control" required value="14">
												...
												<div class="form-group">
													...
													<input type="number" step="any" name="viajes" placeholder="Indique la cantidad de viajes" class="form-control" required value="">
													<small>Decimales separados con punto</small>
												</div>
											</div>
											<div class="col-md-12">
