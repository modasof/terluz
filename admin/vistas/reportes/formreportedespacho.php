...
<div class="box box-primary collapsed-box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
	<form role="form" autocomplete="off" action="?controller=reportes&&action=guardardespacho" method="POST" enctype="multipart/form-data" >
							<?php  
					...
					<div class="card-body">
							<div class="row">
								...
								<select class="form-control" id="tipo_despacho" name="tipo_despacho" required>
										...
										<option value="A patio" selected>A Patio</option>
