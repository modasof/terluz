...
<div class="box box-primary collapsed-box">
            <div class="box-header with-border">
              <h3 class="box-title"> Registrar Insumo x Pagar
            ...
            <!-- /.box-header -->
            <div class="box-body">
	<form role="form" autocomplete="off" action="?controller=reportes&&action=guardarinsumoxpagar" method="POST" enctype="multipart/form-data" >
							<?php  
					...
					<div class="card-body">
							...
							<div class="row">
										...
										<div id="divproveedor" class="col-md-12">
												<div class="form-group">
													<label><a data-toggle="modal" data-target="#modal-form7" href="#"  class="btn btn-success btn-sm"><i class="fa fa-plus-square"></i></a> Seleccione el Proveedor: <span>*</span></label>
								<select class="form-control" id="proveedor_id_proveedor" name="proveedor_id_proveedor" required>
										...
										<?php } ?>
											...
											<div id="divplaca" class="col-md-8">
												<div class="form-group">
													...
													<select class="form-control" id="insumo_id_insumo" name="insumo_id_insumo" required>
															...
															foreach ($rubros as $campo){
																...
																$nombre_unidadmedida = $campo['nombre_unidadmedida'];
            													if ($nombre_unidadmedida==""){$nombre_unidadmedida="Sin Unidad de Medida";}


															?>
															<option value="<?php echo $id_insumo; ?>"><?php echo utf8_encode($nombre_insumo); ?> (<?php echo $nombre_unidadmedida;?>)</option>
															<?php } ?>
													</select>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<select class="form-control" name="vence" required="">
