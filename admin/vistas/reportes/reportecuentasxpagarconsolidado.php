...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Reporte Cuentas x Pagar consolidado</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
	...
	<div class="content">
		<div class="container-fluid">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Cuentas x Pagar </h3>
       ...
       <tbody>
            ...
            if ($fechaform!="") {
              $res=Reportes::ReporteCuentasxpagarporfechaconsolidado($FechaStart,$FechaEnd);
