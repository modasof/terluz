...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Reporte Trituradora</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
            	...
            	require_once 'formreportedespachotrituradora.php';
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Trituradora </h3>
            ...
            <div class="box-body">
            	            <div class="row">
        <form action="?controller=reportes&&action=despachosporfechatrituradora" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
         ...
         ?>
          ...
          <thead>
            <tr style="background-color: #4f5962;color: white;">
              ...
              <th style="width: 10%;">Despacho m3</th>
              <th style="width: 10%;">N. Viajes</th>
              <th>Cliente</th>
              <th>Producto</th>
              <th>Origen</th> 
              <th>Observaciones</th>
       ...
       <tbody>
            <?php
            if ($fechaform!="") {
              $res=Reportes::ReporteDespachosporfechatrituradora($FechaStart,$FechaEnd);
            ...
            <tr>
              <td>
              <a href="?controller=reportes&&action=editardespachotrituradora&&id=<?php echo $id; ?>&&vereditar=1" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Despacho">
              ...
              <td><?php echo utf8_encode($tipo_despacho); ?></td>
               ...
               <td><?php echo utf8_encode($facturado); ?></td>
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=reportes&&action=eliminardespachotrituradora&&id="+id;
else
