...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Reporte Despacho Cliente</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
            	...
            	require_once 'formreportedespachoclientes.php';
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
       ...
       <tbody>
            <?php
            if ($fechaform!="") {
              $res=Reportes::ReporteDespachosporfechaclientes($FechaStart,$FechaEnd);
            ...
            <tr>
              <td>
              <a href="?controller=reportes&&action=editardespachoclientes&&id=<?php echo $id; ?>&&vereditar=1" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Despacho">
             ...
             <a download="Soporte" href="<?php echo($imagen); ?>"  class="tooltip-primary text-dark" title="Descargar Soporte">
              ...
              <td><?php echo utf8_encode($kilometraje); ?></td>
              <td><?php echo utf8_encode("$".number_format($valor_m3,0)); ?></td>
              <td><?php echo utf8_encode("$".number_format($ventatotal,0)); ?></td>
              <td><?php echo utf8_encode($radicada); ?></td>
              <td><?php echo utf8_encode($fecha_radicada); ?></td>
              <td><?php echo utf8_encode($factura); ?></td>
              <td><?php echo utf8_encode($pagado); ?></td>
            </tr>
            <?php
              }
            ?>
