...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Reporte Insumos x Pagar</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
            	...
            	require_once 'formreporteinsumosxpagar.php';
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Insumos x Pagar </h3>
            ...
            <div class="box-body">
            	            <div class="row">
        <form action="?controller=reportes&&action=insumosxpagarporfecha" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
       ...
       <div class="col-sm-12">
        ...
        if ($fechaform!="") {
          ?>
           <h3 class="m-0 text-dark">Reporte Insumos x Pagar del <?php echo(fechalarga($datofechain)) ?> al <?php echo (fechalarga($datofechafinal)) ?></h3>
          <?php
        }
        else
        {
          ?>
           <h3 class="m-0 text-dark">Reporte Total Insumos por Pagar </h3>
          <?php
        }
       ...
       <tbody>
            ...
            if ($fechaform!="") {
              $res=Reportes::ReporteInsumosxpagarporfecha($FechaStart,$FechaEnd);
            ...
            <tr>
              <td>
              <a href="?controller=reportes&&action=editarinsumoxpagar&&id=<?php echo $id; ?>&&vereditar=1" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Compra">
             ...
             <a download="Soporte" href="<?php echo($imagen); ?>"  class="tooltip-primary text-dark" title="Descargar Soporte">
               ...
               <a style="display: none;" href="#"  data-toggle="modal" data-target="#modal-form<?php echo($id) ?>" href="#" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Abonar a cuenta">
    ...
    <div>
                ...
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header"><?php echo utf8_encode("$".number_format($ventatotal,0)); ?></h5>
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=reportes&&action=eliminarinsumoxpagar&&id="+id;
else
...
function pagarcuenta(id){
   ...
   if (eliminar)
     window.location.href="?controller=reportes&&action=cancelarinsumoxpagar&&id="+id;
else
  //Y aquí pon cualquier cosa que quieras que salga si le diste al boton de cancelar
