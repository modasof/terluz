...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Reporte Venta</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
            	...
            	require_once 'formreporteventa.php';
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
            	            <div class="row">
        <form action="?controller=reportes&&action=ventasporfecha" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
       ...
       <div class="col-sm-12">
        ...
        if ($fechaform!="") {
          ?>
           <h3 class="m-0 text-dark">Reporte Ventas del <?php echo(fechalarga($datofechain)) ?> al <?php echo (fechalarga($datofechafinal)) ?></h3>
          <?php
        }
        else
        {
          ?>
           <h3 class="m-0 text-dark">Reporte Total Ventas </h3>
          <?php
        }
       ...
       <tbody>
            <?php
            if ($fechaform!="") {
              $res=Reportes::ReporteVentasporfecha($FechaStart,$FechaEnd);
            ...
            $cantidaddespachos=Totaldespachosporfactura($num_factura);
            ...
            $saldo=$valor_m3-$abonos;
            ?>
            <tr>
              <td>
              <a href="?controller=reportes&&action=editarventa&&id=<?php echo $id; ?>&&vereditar=1" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Venta">
                <i class="fa fa-edit bigger-110 "></i>
              </a>
              <a href="#" onclick="eliminar(<?php echo $id; ?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar Venta">
    ...
    <div>
                  ...
                  <div class="modal-dialog ">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <p><strong>Detalle Venta:</strong>Venta de <?php echo($cantidad." m3 de ".$nomprod." a ".$nomcli); ?></p>
                        <div class="row">
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header"><?php echo utf8_encode("$".number_format($valor_m3,0)); ?></h5>
                    <span class="description-text">Valor Venta</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
          ...
          <input type="hidden" name="reporte_id_factura" value="<?php echo($id);?>">
          <input type="hidden" name="reporte_id_prestamo" value="0">
           <input type="hidden" name="reporte_id_cuentaxpagar" value="0">
    ...
    $(document).ready(function() {
        ...
        //dateFormat: 'dd/mm/yy'
            ...
            <!-- FINAL MODAL -->
              ...
              <td>
                <a href="?controller=ventasdespachos&action=todos&id=<?php echo $num_factura; ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Ver Despachos de esta Venta"> 
                  (<?php if ($cantidaddespachos==""){$cantidaddespachos=0;} echo $cantidaddespachos;?>)
                  Despachos
                </a>
              </td>
              ...
              else
              {
               ...
               ?>
              <td><?php 
              $saldopendiente=$valor_m3-$abonos;
              echo utf8_encode("$".number_format($saldopendiente,0)); ?></td>
              <td><?php echo utf8_encode($nomcli); ?></td>
              <td><?php echo utf8_encode($nomprod); ?></td>
            
               <td><?php echo utf8_encode($observaciones); ?></td>
               <td><?php echo utf8_decode($estado_pago); ?></td>
...
<form action="?controller=reportes&&action=clienteextra&&tiporeporte=1" method="post" autocomplete="off">
                  <div class="modal-dialog ">
                    <div class="modal-content">
                      <div class="modal-header">
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=reportes&&action=eliminarventa&&id="+id;
else
...
function cambiarestado(id){
   ...
   if (eliminar)
     window.location.href="?controller=reportes&&action=cambiarestadoventa&&id="+id;
else
  //Y aquí pon cualquier cosa que quieras que salga si le diste al boton de cancelar
...
function eliminarabono(idabono,idsol){
   ...
   if (eliminar)
     window.location.href="?controller=reportes&&action=eliminarabono&&idabono="+idabono+"&&id="+idsol+"&&tipo=Material";
else
  //Y aquí pon cualquier cosa que quieras que salga si le diste al boton de cancelar
