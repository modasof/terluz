...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Listado de Personal Extra</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
?>
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Listado de Personal Extra </h3>
    ...
    ?>
            <tr>
             ...
             <a target="_blank" href="<?php echo($imagen); ?>"  class="tooltip-primary text-primary" title="Ver Soporte">
              ...
              <a href="?controller=personalextra&&action=editar&&id=<?php echo $id_extra; ?>&&vereditar=1" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar">
                <i class="fa fa-edit bigger-110 "></i>
              </a>
              <a href="#" onclick="eliminar(<?php echo $id_extra; ?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar">
                <i class="fa fa-trash bigger-110 "></i>
              </a>
              </td>
              <td><?php echo ("PE-" . $id_extra); ?></td>
              <td><?php echo utf8_decode($documento); ?></td>
              <td><?php echo utf8_decode($nombre_extra); ?></td>
              <td><?php echo utf8_decode($celular_extra); ?></td>
              <td><?php echo utf8_decode($cargo); ?></td>
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=personalextra&&action=eliminar&&id="+id;
else
