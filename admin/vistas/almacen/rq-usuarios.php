         ...
         <div class="box">
            ...
            <div class="box-body">
              <a href="?controller=index&&action=vistarqusuariosdashboard" class="btn btn-app">
                <i class="fa fa-users text-danger"></i> RQ Usuarios
              </a>
          ...
          <div class="box">
            <div  class="box-header with-border">
              <h3 class="box-title "><strong>RQ- Usuarios</strong></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered" style="font-size: 13px;">
                ...
                <?php
$res1    = Requisicionesitems::listaRqusuarios();
$campos1 = $res1->getCampos();
foreach ($campos1 as $campo1) {
    $listaRqusuarios = $campo1['usuario_creador'];
    $nomusuario = Usuarios::obtenerNombreUsuario($listaRqusuarios);
    $totalRq    = contarregistrosporusuario($listaRqusuarios);

    ?>
                <tr>
                  <td><?php echo ($listaRqusuarios); ?></td>
                  <td><?php echo ($nomusuario); ?></td>
                  <td><?php echo ($totalRq); ?></td>
                </tr>
                <?php
}
?>
         ...
         <div class="col-md-8">
                        <div class="form-group">
                          <label>Entregas pendientes por Fecha<span>*</span></label>
