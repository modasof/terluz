...
$res=Reportesproduccion::editarreporteproduccionPor($idventa);
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Editar Registro Producción</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
            <li class="breadcrumb-item"><a href="?controller=reportesproduccion&&action=reportesproduccion">Reporte Proudcción</a></li>
	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
						...
						<!-- left column -->
						<div class="col-md-8">
	<form role="form" autocomplete="off" action="?controller=reportesproduccion&&action=actualizarreporteproduccion&&id=<?php echo($idventa); ?>" method="POST" enctype="multipart/form-data" >
							<?php  
							...
							<div class="row">
								...
								<select class="form-control" id="despachador_tm" name="despachador_tm" required>
										...
										<?php } ?>
											...
											<div id="" class="col-md-12">
												<div class="form-group">
													<label> Registro a: <span>*</span></label>
								<select class="form-control" id="tipo_despacho" name="tipo_despacho" required>
										...
										<option value="Trituradora">A Trituradora</option>
