...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Reporte Producción</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
            	...
            	require_once 'formreporteproduccion.php';
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
            	            <div class="row">
        <form action="?controller=reportesproduccion&&action=reportesporfechaproduccion" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
       ...
       <div class="col-sm-12">
        ...
        if ($fechaform!="") {
          ?>
           <h3 class="m-0 text-dark">Reporte Producción del <?php echo(fechalarga($datofechain)) ?> al <?php echo (fechalarga($datofechafinal)) ?></h3>
          <?php
        }
        else
        {
          ?>
           <h3 class="m-0 text-dark">Reporte Total Producción </h3>
          <?php
        }
         ...
         ?>
          ...
          <thead>
            <tr style="background-color: #4f5962;color: white;">
              ...
              <th style="width: 10%;">N. Mezclas</th>
              <th>Operador</th>
              <th>Producto</th>
              <th>Origen</th> 
              <th>Horas</th>
              <th>Rendimiento x Hora</th>
       ...
       <tbody>
            <?php
            if ($fechaform!="") {
              $res=Reportesproduccion::reportesporfechaproduccion($FechaStart,$FechaEnd);
            ...
            $horas = $campo['horas'];
            $rendimiento = $campo['rendimiento'];
            $transportado_por = $campo['transportado_por'];
            $facturado = $campo['facturado'];
            ...
            $nomoperador=funcionarios::obtenerNombreFuncionario($transportado_por);
            $nomequipo=Equipos::obtenerNombreEquipo($equipo_id_equipo);
            $ventatotal=$cantidad*$valor_m3;
            ?>
            <tr>
              <td>
              <a href="?controller=reportesproduccion&&action=editarreporteproduccion&&id=<?php echo $id; ?>&&vereditar=1" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Despacho">
              ...
              <td><?php echo utf8_encode($viajes); ?></td>
              <td><?php echo utf8_encode($nomoperador); ?></td>
              <td><?php echo utf8_encode($nomprod); ?></td>
              <td><?php echo utf8_encode($tipo_despacho); ?></td>
               <td><?php echo utf8_encode($horas); ?></td>
               <td><?php echo utf8_encode($rendimiento); ?></td>
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=reportesproduccion&&action=eliminarreporteproduccion&&id="+id;
else
