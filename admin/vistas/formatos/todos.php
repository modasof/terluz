...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Formatos Contables</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
            <li class="breadcrumb-item active">Formatos Contables</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <div class="content">
    ...
    <div class="card card-default">
      <div class="card-body">
          <a href="?controller=formatos&&action=nuevo&&IdSesion=rh" class="btn btn-success" style="float: right;"><i class="fa fa-file-text-o bigger-110 "></i> Cargar Documento</a>
...
function eliminar($id,$modulo){
   ...
   if (eliminar)
    //alert($modulo);
    window.location.href="?controller=formatos&&action=eliminar&&id="+$id+"&&modulo="+$modulo;
else
