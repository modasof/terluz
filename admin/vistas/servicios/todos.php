      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Servicios Requisición</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
      <div class="row">
		...
		<div class="card card-primary">
			<div class="card-body">
				  <a href="?controller=servicios&&action=nuevo" class="btn btn-success" style="float: right;"><i class="fa fa-file-text-o bigger-110 "></i>Nueva Servicio</a>
				  <br><br>
            ...
            $nomunidad=Unidadesmed::obtenerNombre($unidadmedida_id);
              ...
              <td><?php echo $nomunidad; ?></td>
							<td>
							<a href="?controller=servicios&&action=editar&&id=<?php echo $id; ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar ">
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=servicios&&action=eliminar&&id="+id;
else
