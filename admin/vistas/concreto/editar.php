...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Editar Despacho Concreto</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
	...
	<form role="form" autocomplete="off" action="?controller=concreto&&action=actualizar&&id=<?php echo($idventa); ?>" method="POST" enctype="multipart/form-data" >
							<?php  
										...
										<?php } ?>
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<input type="number" step="any" name="contador1" placeholder="Contador Inicial" class="form-control" required value="<?php echo $cantidad;?>">
												</div>
											</div>
											<div class="col-md-2">
												<div class="form-group">
													<label>Contador Final<span>*</span></label>
													<input type="number" step="any" name="contador2" placeholder="Contador Final" class="form-control" required value="<?php echo $cantidad;?>">
												</div>
											</div>
											<div class="col-md-2">
												<div class="form-group">
													<label>Total Puntos<span></span></label>
													<input type="number" step="any" name="puntos" placeholder="Total Puntos" class="form-control"  value="<?php echo $cantidad;?>">
												</div>
											</div>
