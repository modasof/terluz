...
<?php if ($RolSesion == 1 or $RolSesion == 13) {
        ...
        <?php
         ...
         <li>
               <a href="?controller=requisicionesitems&&action=todosporreq&&id=<?php echo ($requisicion_id) ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Ver RQ Completa">
                <i class="fa fa-plus-square bigger-110 "> Ver RQ Completa</i>
              </a>
        </li>
...
# ======  Si es estado Solicitado = 1 Si deja Editar/Eliminar el Item   =======
    if ($estado_item == 1) {
        ?>
        <li>
               <a href="?controller=requisicionesitems&&action=todosporreq&&id=<?php echo ($requisicion_id) ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Agregar Insumos">
    ...
    ?>
    <?php
if ($estadosolicitado == 1) {
        ?>

        <li>
               <a href="?controller=movimientositem&&action=todospor&&item_id=<?php echo ($iditem) ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Gestionar Cantidades">
                <i class="fa fa-plus-square bigger-110 "> Gestionar Cantidades</i>
              </a>
        </li>
