...
<div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Mis Requisiciones de Insumos </h3>
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
       ...
       <tbody>
            ...
            $estadoactual= Estadosreq::obtenerNombre($estado_id_requisicion);
            ...
            <tr>
              ...
              <td><a href="?controller=requisicionesitems&&action=todosporreq&&id=<?php echo($id) ?>"> (<?php echo utf8_encode($totalitems); ?>) Insumos Solicitados</a></td>
              ...
              <li>
               <a href="?controller=requisicionesitems&&action=todosporreq&&id=<?php echo($id) ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Agregar Insumos">
              ...
              <a download="Soporte" href="<?php echo($imagen); ?>"  class="tooltip-primary text-dark" title="Descargar Soporte">
                <i class="fa fa-cloud-download bigger-110 "> Descargar</i>
                          ...
                          <li>
              <a href="?controller=requisiciones&&action=editar&&id=<?php echo $id; ?>&&vereditar=1" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar">
