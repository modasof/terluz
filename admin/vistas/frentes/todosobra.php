  ...
  <div class="content">
    ...
    <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"> Crear Nuevo Frente
    ...
    <form role="form" autocomplete="off" action="?controller=frentes&&action=guardar&id_obra=<?php echo($getobra); ?>" method="POST" enctype="multipart/form-data" >
                            <?php  
                                date_default_timezone_set("America/Bogota");
                                $TiempoActual = date('Y-m-d H:i:s');
                            ?>
                <input type="hidden" name="obra_id_obra" value="<?php echo($getobra);?>">
                <input type="hidden" name="estado_frente" value="1">
                <input type="hidden" name="marca_temporal" value="<?php echo($TiempoActual);?>">
                <input type="hidden" name="frente_publicado" value="1">
                            ...
                            <div class="row">
                                     ...
                                     <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Nombre Frente: <span>*</span></label>
      <input  type="text" name="nombre_frente" placeholder="Digite el nombre" class="form-control">
                                                </div>
                                    </div>
                  ...
                  <textarea class="form-control" rows="1" id="descripcion" name="observaciones"></textarea>
                        </div>
                      </div>
    ...
    <div class="card card-default">
      ...
      <div class="clearfix">
          ...
          <tbody>
            <?php
            $campos = Frentes::obtenerPaginafrentes($getobra);
            ...
            ?>
            <tr>
             <form role="form" autocomplete="off" action="?controller=frentes&&action=actualizar&id_obra=<?php echo($getobra); ?>&&id=<?php echo($id); ?>" method="POST" enctype="multipart/form-data" >
              
              <td><?php echo utf8_decode($id) ?></td>
               <td>
                <input type="text" name="nombre_frente" value="<?php echo utf8_decode($nombre_frente) ?>">
              </td>
                <td>
                  <input type="text" name="observaciones" value="<?php echo utf8_decode($observaciones) ?>">
                </td>
              <td>
                 <div class="btn-group">
             ...
             <button  type="submit" class="btn btn-default btn-flat"><i class="fa fa-refresh bigger-110"></i></button>
                    </div>
...
function eliminar(id,$getobra){
   ...
   if (eliminar)
window.location.href="?controller=frentes&&action=eliminar&&id="+id+"&&id_obra="+$getobra+"";
else
