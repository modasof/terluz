...
/*************************************************************/
	...
	function todos() {
		$campos=Combustible::obtenerPagina();;
		require_once 'vistas/combustible/todos.php';
	}
...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/combustible/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = Combustible::obtenerPaginaPor($id);
		require_once 'vistas/combustible/editar.php';
	}
...
/*************************************************************/
	function eliminar() {
		$id = $_GET['id'];
		$res = Combustible::eliminarPor($id);
		if ($res){
...
function guardar() {
	...
	$campo = new Combustible('',$nuevoarreglo);
	$res = Combustible::guardar($campo);
	if ($res){
...
function actualizar(){
	...
	$datosguardar = new Combustible($id,$nuevoarreglo);
	$res = Combustible::actualizar($id,$datosguardar);
	if ($res){
