...
/*************************************************************/
	...
	function todos() {
		$campos=Estadosreq::obtenerPagina();;
		require_once 'vistas/estadosreq/todos.php';
	}
...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/estadosreq/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = Estadosreq::obtenerPaginaPor($id);
		require_once 'vistas/estadosreq/editar.php';
	}
...
function guardar() {
	...
	$campo = new Estadosreq('',$nuevoarreglo);
	$res = Estadosreq::guardar($campo);
	if ($res){
...
function actualizar(){
	...
	$datosguardar = new Estadosreq($id,$nuevoarreglo);
	$res = Estadosreq::actualizar($id,$datosguardar);
	if ($res){
