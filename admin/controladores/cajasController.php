...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/cajas/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = Cajas::obtenerPaginaPor($id);
		require_once 'vistas/cajas/editar.php';
	}
...
function actualizar(){
	...
	$datosguardar = new Cajas($id,$nuevoarreglo);
	$res = Cajas::actualizar($id,$datosguardar);
	if ($res){
