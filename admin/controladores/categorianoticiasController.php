<?php
class CategorianoticiasController {
...
/*************************************************************/
	...
	function todos() {
		$campos=Categorianoticias::obtenerPagina();;
		require_once 'vistas/categorianoticias/todos.php';
	}
...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/categorianoticias/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = Categorianoticias::obtenerPaginaPor($id);
		require_once 'vistas/categorianoticias/editar.php';
	}
...
/*************************************************************/
	function eliminar() {
		$id = $_GET['id'];
		$res = Categorianoticias::eliminarPor($id);
		if ($res){
...
function guardar() {
	...
	$campo = new Categorianoticias('',$nuevoarreglo);
	$res = Categorianoticias::guardar($campo);
	if ($res){
...
function actualizar(){
	...
	$datosguardar = new Categorianoticias($id,$nuevoarreglo);
	$res = Categorianoticias::actualizar($id,$datosguardar);
	if ($res){
