...
/*************************************************************/
	...
	function todos() {
		$campos=Servicios::obtenerPagina();;
		require_once 'vistas/servicios/todos.php';
	}
...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/servicios/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = Servicios::obtenerPaginaPor($id);
...
function guardar() {
	...
	$campo = new Servicios('',$nuevoarreglo);
	$res = Servicios::guardar($campo);
	if ($res){
...
function actualizar(){
	...
	$datosguardar = new Servicios($id,$nuevoarreglo);
	$res = Servicios::actualizar($id,$datosguardar);
	if ($res){
