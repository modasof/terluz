...
/*************************************************************/
	...
	function todos() {
		$id = $_GET['id_usuario'];
		$campos=Misdocumentos::obtenerPagina($id);;
		require_once 'vistas/misdocumentos/todos.php';
	}
...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/misdocumentos/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = Misdocumentos::obtenerPaginaPor($id);
		require_once 'vistas/misdocumentos/editar.php';
	}
...
/*************************************************************/
	function eliminar() {
		...
		$res = Misdocumentos::eliminarPor($id);
		if ($res){
			echo "<script>jQuery(function(){Swal.fire(\"¡Datos eliminados!\", \"Se han eliminado correctamente los datos\", \"success\");});</script>";
		}else{
				echo "<script>jQuery(function(){Swal.fire(\"¡Error al eliminar!\", \"No se han eliminado correctamente los datos\", \"error\");});</script>";
		}
		$campos = Misdocumentos::obtenerPagina($id_usuario);
		require_once 'vistas/misdocumentos/todos.php';
	}
...
function guardar() {
	...
	$ruta_imagen=$this->subir_fichero('images/misdocumentos','imagen');
	...
	$res = Misdocumentos::guardar($campo,$ruta_imagen);
	if ($res){
...
function actualizar(){
	...
	$res = Misdocumentos::actualizar($id,$datosguardar,$ruta_imagen);
	if ($res){
