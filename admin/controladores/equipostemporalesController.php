<?php
class EquipostemporalesController {
...
/*************************************************************/
	...
	function todos() {
		$campos=Equipostemporales::obtenerPagina();;
		require_once 'vistas/equipostemporales/todos.php';
	}
...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/equipostemporales/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = Equipostemporales::obtenerPaginaPor($id);
		require_once 'vistas/equipostemporales/editar.php';
	}
...
/*************************************************************/
	function eliminar() {
		$id = $_GET['id'];
		$res = Equipostemporales::eliminarPor($id);
		if ($res){
...
function guardar() {
	...
	$campo = new Equipostemporales('',$nuevoarreglo);
	$res = Equipostemporales::guardar($campo);
	if ($res){
...
function actualizar(){
	...
	$datosguardar = new Equipostemporales($id,$nuevoarreglo);
	$res = Equipostemporales::actualizar($id,$datosguardar);
	if ($res){
