...
/*************************************************************/
	...
	function agregados() {
		...
		$campos=Agregadosobra::ReporteAgregados($id_obra);;
		require_once 'vistas/agregadosobra/todos.php';
	}
...
function guardar() {
	...
	$id_obra=$_GET['id_obra'];
	$ruta_imagen=$this->subir_fichero('images/remisioninsumos','imagen');
	$variable = $_POST;
	$nuevoarreglo = array();
	extract($variable);
	...
	$campo = new Agregadosobra('',$nuevoarreglo);
	$res = Agregadosobra::guardar($campo,$ruta_imagen);
	if ($res){
...
/*************************************************************/
	function eliminar() {
		$id = $_GET['id'];
		$id_obra = $_GET['id_obra'];
		$res = Agregadosobra::eliminarPor($id);
		if ($res){
...
/*************************************************************/
	function editar() {
		...
		$campos = Agregadosobra::editarPor($id);
		require_once 'vistas/agregadosobra/formeditar.php';
	}
...
function actualizar(){
	...
	$datosguardar = new Agregadosobra($id,$nuevoarreglo);
	$res = Agregadosobra::actualizar($id,$datosguardar,$ruta_imagen);
	if ($res){
