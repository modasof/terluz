...
/*************************************************************/
	...
	function todos() {
		$campos=estaciones::obtenerPagina();;
		require_once 'vistas/estaciones/todos.php';
	}
...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/estaciones/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = estaciones::obtenerPaginaPor($id);
		require_once 'vistas/estaciones/editar.php';
	}
...
function actualizar(){
	$id=$_GET['id'];
	$campo=$_POST['nombre_estacion'];
	$res = estaciones::actualizarNombre($campo,$id);
	if ($res){
		echo "<script>jQuery(function(){swal(\"¡Datos guardados!\", \"Se han guardado correctamente los datos\", \"success\");});</script>";
	}else{
		echo "<script>jQuery(function(){swal(\"¡Erro al guardar!\", \"No se han guardado correctamente los datos\", \"error\");});</script>";
