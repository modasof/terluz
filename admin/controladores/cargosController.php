...
/*************************************************************/
	...
	function todos() {
		$campos=Cargos::obtenerPagina();;
		require_once 'vistas/cargos/todos.php';
	}
...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/cargos/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = Cargos::obtenerPaginaPor($id);
		require_once 'vistas/cargos/editar.php';
	}
...
function actualizar(){
	...
	$datosguardar = new Cargos($id,$nuevoarreglo);
	$res = Cargos::actualizar($id,$datosguardar);
	if ($res){
