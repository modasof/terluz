...
/*************************************************************/
	...
	function todos() {
		$campos=Transmision::obtenerPagina();;
		require_once 'vistas/transmision/todos.php';
	}
...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/transmision/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = Transmision::obtenerPaginaPor($id);
		require_once 'vistas/transmision/editar.php';
	}
...
/*************************************************************/
	function eliminar() {
		$id = $_GET['id'];
		$res = Transmision::eliminarPor($id);
		if ($res){
...
function guardar() {
	...
	$campo = new Transmision('',$nuevoarreglo);
	$res = Transmision::guardar($campo);
	if ($res){
...
function actualizar(){
	...
	$datosguardar = new Transmision($id,$nuevoarreglo);
	$res = Transmision::actualizar($id,$datosguardar);
	if ($res){
