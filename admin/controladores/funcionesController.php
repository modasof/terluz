...
/*************************************************************/
	...
	function todos() {
		$campos=Funciones::obtenerPagina();;
		require_once 'vistas/funciones/todos.php';
	}
...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/funciones/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = Funciones::obtenerPaginaPor($id);
		require_once 'vistas/funciones/editar.php';
	}
...
function guardar() {
	...
	$campo = new Funciones('',$nuevoarreglo);
	$res = Funciones::guardar($campo);
	if ($res){
...
function actualizar(){
	...
	$datosguardar = new Funciones($id,$nuevoarreglo);
	$res = Funciones::actualizar($id,$datosguardar);
	if ($res){
