...
/*************************************************************/
	...
	function todos() {
		$campos=Marcas::obtenerPagina();;
		require_once 'vistas/marcasu/todos.php';
	}
...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/marcasu/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = Marcas::obtenerPaginaPor($id);
		require_once 'vistas/marcasu/editar.php';
	}
...
function guardar() {
	...
	$ruta_imagen=$this->subir_fichero('../pagina/images/marcas','imagen');
	...
	$campo = new Marcas('',$nuevoarreglo);
	$res = Marcas::guardar($campo,$ruta_imagen);
	if ($res){
...
function actualizar(){
	...
	$datosguardar = new Marcas($id,$nuevoarreglo);
	$res = Marcas::actualizar($id,$datosguardar,$ruta_imagen);
	if ($res){
