...
function guardar() {
	...
	if ($res){
		echo "<script>jQuery(function(){swal(\"¡Datos actualizados!\", \"Se ha actualizado correctamente la pagina\", \"success\").then(function(){window.location='?controller=requisicionesitems&&action=todosporreq&&id=".$ultimoid."';});});</script>";
	}else{
