...
/*************************************************************/
	...
	function index() { 
		...
		require_once 'vistas/politicas/index.php';
	}
...
function actualizar(){
	...
	$res = Nosotros::actualizar($id,$datosguardar);
	
	if ($res){
		echo "<script>jQuery(function(){Swal.fire(\"¡Datos actualizados!\", \"Se ha actualizado correctamente la pagina de políticas\", \"success\");});</script>";
	}else{
