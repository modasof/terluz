...
/*************************************************************/
	...
	function todos() { 
		$campos=Ventajas::obtenerPagina();;
		require_once 'vistas/ventajas/todos.php';
	}
...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/ventajas/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = Ventajas::obtenerPaginaPor($id);
		require_once 'vistas/ventajas/editar.php';
	}
...
function guardar() {
	...
	$ruta_imagen=$this->subir_fichero('../pagina/images/ventajas','imagen');
	...
	$campo = new Ventajas('',$nuevoarreglo);
	$res = Ventajas::guardar($campo,$ruta_imagen);
	if ($res){
...
function actualizar(){
	...
	$datosguardar = new Ventajas($id,$nuevoarreglo);
	$res = Ventajas::actualizar($id,$datosguardar,$ruta_imagen);
	if ($res){
