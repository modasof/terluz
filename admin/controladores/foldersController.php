...
/*************************************************************/
	...
	function todos() {
		$campos=Folders::obtenerPagina();;
		require_once 'vistas/folders/todos.php';
	}
...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/folders/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = Folders::obtenerPaginaPor($id);
		require_once 'vistas/folders/editar.php';
	}
...
function guardar() {
	...
	$campo = new Folders('',$nuevoarreglo);
	$res = Folders::guardar($campo);
	if ($res){
...
function actualizar(){
	$id=$_GET['id'];
	$campo=$_POST['nombre_folder'];
	$res = Folders::actualizarNombre($campo,$id);
	if ($res){
		echo "<script>jQuery(function(){swal(\"¡Datos guardados!\", \"Se han guardado correctamente los datos\", \"success\");});</script>";
	}else{
		echo "<script>jQuery(function(){swal(\"¡Erro al guardar!\", \"No se han guardado correctamente los datos\", \"error\");});</script>";
