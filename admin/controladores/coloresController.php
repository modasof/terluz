...
/*************************************************************/
	...
	function todos() {
		$campos=Colores::obtenerPagina();;
		require_once 'vistas/colores/todos.php';
	}
...
/*************************************************************/
	function nuevo() {
		require_once 'vistas/colores/nuevo.php';
	}
...
/*************************************************************/
	function editar() {
		$id = $_GET['id'];
		$campos = Colores::obtenerPaginaPor($id);
		require_once 'vistas/colores/editar.php';
	}
...
function guardar() {
	...
	$campo = new Colores('',$nuevoarreglo);
	$res = Colores::guardar($campo);
	if ($res){
...
function actualizar(){
	...
	$datosguardar = new Colores($id,$nuevoarreglo);
	$res = Colores::actualizar($id,$datosguardar);
	if ($res){
