...
public static function obtenerPagina(){
	try {
		...
		$select=$db->query("SELECT * FROM versiones");
...
** FUNCION PARA MOSTRAR TODOS LOS CAMPOS DE FILTRADOS POR ID  **
***************************************************************/
public static function obtenerModelouPor($id){
	try {
		$db=Db::getConnect();
...
** FUNCION PARA MOSTRAR TODOS LOS CAMPOS DE FILTRADOS POR ID  **
***************************************************************/
public static function obtenerMarcauPor($id){
	try {
		$db=Db::getConnect();
...
public static function eliminarPor($id){
	try {
		$db=Db::getConnect();
		$select=$db->query("DELETE FROM versiones WHERE id='".$id."'");
		if ($select){
			return true;
			}else{return false;}
	}
...
public static function actualizar($id,$campos){
	try {
		...
		$update=$db->prepare('UPDATE versiones SET
								id_modelo=:id_modelo,
								id_marca=:id_marca,
								version=:version
								WHERE id=:id');
...
public static function guardar($campos){
	try {
		...
		$insert=$db->prepare('INSERT INTO versiones VALUES (NULL,:id_modelo,:id_marca,:version)');
