...
public static function obtenerMarcas(){
	try {
		$db=Db::getConnect();
		$select=$db->query("SELECT id,marca FROM marcasu");
...
public static function obtenerMarca($id){
	try {
		$db=Db::getConnect();
		$select=$db->query("SELECT marca FROM marcasu WHERE id = '".$id."'");
...
public static function obtenerPagina(){
	try {
		...
		$select=$db->query("SELECT * FROM modelosu");
...
public static function eliminarPor($id){
	try {
		$db=Db::getConnect();
		$select=$db->query("DELETE FROM modelosu WHERE id='".$id."'");
		if ($select){
			return true;
			}else{return false;}
	}
...
public static function actualizar($id,$campos){
	try {
		...
		$update=$db->prepare('UPDATE modelosu SET
								id_marca=:id_marca,
								modelo=:modelo
								WHERE id=:id');
...
public static function guardar($campos){
	try {
		...
		$insert=$db->prepare('INSERT INTO modelosu VALUES (NULL,:id_marca,:modelo)');
